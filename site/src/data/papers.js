...
export const papers = [
  {
    ...
    "venue": "This paper has been accepted by IEEE TASE 2026",
    ...
    "abstractZh": "导航是自主系统的基础能力，但多数方法依赖结构化模型与强先验，开放不确定环境中鲁棒性不足。VLN 以数据驱动融合自然语言理解与视觉感知，系统分类与实机验证仍有限。本综述沿动作范式（层次化与单体）和模型范式（判别与生成）组织前沿方法并分析优劣，并在实体机器人上对代表性 VLN 配置做真实评测。十个多样真实场景显示仿真与实机差距显著：单体仅 RGB 方法仿真成功率 61%、实机 22%，层次化框架实机达 51%。最后指出感知、决策与控制的关键挑战。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2607.09792",
    "pdf": "https://arxiv.org/pdf/2607.09792"
  },
  {
    "id": "2608.29208",
    "nickname": "AdaVLA",
    ...
    "venue": "Accepted to the 2026 IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS 2026)",
    ...
    "abstractZh": "建立在 VLM 之上的 VLA 借助互联网规模知识与多模态推理提升机器人能力，但计算开销制约端侧部署与实时响应。现有加速常需微调或训练数据，且多只降低 VLM 推理成本，未处理 flow matching 中的迭代 ODE 求解。本文提出 AdaVLA：面向 flow-matching VLA 的在线、免训练自适应框架，由轨迹曲率度量动作生成置信度，动态减少推理步并自适应调整 MLP 剪枝比，无需训练数据。在 LIBERO 与 Jetson AGX Orin 上，对 π₀.₅ 与 X-VLA 分别获得 1.87× 与 2.24× 加速且成功率几乎不降，并以 SmolVLA 在真实任务上验证鲁棒性。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2608.29208"
  },
  {
    "id": "2607.21725",
    "nickname": "2607.21725",
    ...
    "abstractZh": "Physical Agency 指出通才机器人的编排缺口：仅有冻结 VLA 不够，需要规划、执行、验证与恢复的闭环物理智能体。系统把 TiPToP 等当作可调用工具，强调 Agent 层与策略层分离。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2607.21725",
  ...
  },
  {
    ...
    "abstractZh": "语言条件四旋翼飞行需锚定语义目标、预判自运动的视觉后果，并输出平滑可执行的控制参考。现有空中 VLN 与 VLA 多用离散动作、高层航点或瞬时速度，对动作如何改变未来观测监督不足。本文提出 AeroAct：以动作为中心的 world-action model，适配预训练视频扩散 Transformer，由自我中心视觉历史、本体感觉与语言预测局部轨迹-动作块；训练用未来第一人称帧作稠密后果监督，部署时直接解码动作而不生成未来视频。配合 DiffAero 管线、手持采集与自引导时序一致性，闭环仿真与实机表明时序视觉上下文提升跟踪与搜索，且策略可在实体四旋翼上执行。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "零样本连续环境 VLN（VLN-CE）已可借助大型 VLM 实现，但现有方法常依赖学得的航点预测器，限制动作空间且未有效利用深度；记忆则堆积冗长无关历史或检索跨回合经验，削弱零样本设定。本文提出 AgenticNav：将零样本 VLN-CE 重思为 VLM 与环境的 agentic 接口，把动作、深度与记忆暴露为可调用工具——在 RGB 中直接选目标像素并转为运动，按需查询像素深度，并以紧凑地图加回忆工具选择性回顾过去观测。在 R2R-CE 上以相同 VLM 骨干取得零样本 SOTA，实机验证泛化；消融表明动作工具优于传统航点预测器，深度工具与 agentic 记忆亦有贡献。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2606.10577",
    "pdf": "https://arxiv.org/pdf/2606.10577"
  },
  {
    "id": "2608.12835",
    "nickname": "AirForesight",
    ...
    "venue": "Accepted by ACM Multimedia 2026",
    ...
    "abstractZh": "UAV-VLN 要求智能体遵循语言指令、从稀疏多视图推断空间结构，并在复杂室外执行可行 3D 运动。现有方法多将视觉-语言直接映射为动作，显式场景锚定与面向未来的空间推理不足。本文提出 AirForesight：先从多视图学习结构化当前地图，并以当前地图重建与未来轨迹预测联合监督；在结构化因果注意力下将当前空间知识传播到未来地图推理，聚合后预测下一 3D 航点。跨空间规划一致性损失促使地图空间预测轨迹与由真值航点位移得到的专家动作方向一致。OpenUAV 与 AerialVLN-S 实验及消融支持该框架的有效性与稳定性。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2608.12835",
  ...
  },
  {
    ...
    "abstractZh": "CaP-X 提供评测与改进机器人操作编码智能体的框架，直接继承 Code as Policies 一线，用基准衡量「写策略代码的 Agent」在操作上的能力与改进空间。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2603.22435"
  },
  {
    "id": "2601.21998",
    "nickname": "2601.21998",
    ...
    "abstractZh": "Causal World Modeling for Robot Control 强调因果世界建模以服务机器人控制，针对相关但不一定可干预的预测问题，把因果结构引入动作条件预测。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "Cosmos Policy 把视频世界模型微调为视觉运动控制与规划策略，展示 Cosmos 预测模型如何变成可部署的控制 / 规划器。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Efficient and high-fidelity world model. Code is available at https://hcplab-sysu.github.io/DDP-WM",
    ...
    "abstractZh": "World Model 对自主机器人规划至关重要，但现有稠密 Transformer 模型计算开销大，难以实时部署。本文提出以解耦动力学预测为核心的 DDP-WM：假设观测场景中潜在状态演化可分解为物理交互驱动的稀疏主动力学与上下文驱动的背景更新。架构结合高效历史处理与动态定位以隔离主动力学，并用交叉注意力更新背景，优化资源分配并为规划器提供平滑优化景观。实验覆盖导航、精细桌面操作及可变形或多体交互；在 Push-T 上相对稠密 SOTA 约 9 倍推理加速，MPC 成功率由 90% 升至 98%。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_api",
    "arxiv": "https://arxiv.org/abs/2602.01780",
    "pdf": "https://arxiv.org/pdf/2602.01780"
  },
  {
    "id": "2608.12308",
    "nickname": "DreamFly",
    ...
    "venue": "24 pages, 6 figures, 3 tables",
    ...
    "abstractZh": "空中 VLN 要求智能体随时间整合视觉证据、规划未来动作，并在部分可观测下判断是否到达目标。将 VLA 适配到空中导航仍受历史上下文有限、规划时域短与隐式终止不可靠制约。本文提出基于 Dream-VLA 的扩散框架 DreamFly：以因果对齐历史记忆仅用当前决策步之前的观测增强视觉表示；将导航表述为滚动时域扩散规划，预测 K 步动作块但只执行第一步再重规划；LiteStop 从初始全掩码状态的动作 logits 直接估计停止概率。OpenFly 上 test-seen/unseen 的 SR 为 32.04%/29.46%、SPL 为 28.22%/23.54%，优于对比方法且导航误差最低。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2608.12308"
  },
  {
    "id": "2609.01281",
    "nickname": "EmbodiedSkills",
    ...
    "abstractZh": "EmbodiedSkills 把技能决策当作执行提案：运行时检查前提、执行有界 VLA、事后验证，并用固定可执行技能接口连接规划、执行与恢复。在 RoboTwin 2.0 与 LIBERO 上，任务适应的低层 VLA 平均成功率分别达 86.20% 与 97.40%；记忆依赖的 RMBench 仍仅 12.5%，暴露 Agent 记忆挑战。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Accepted to ICML 2026. Project Page: https://dvirsamuel.github.io/fast-auto-regressive-video/",
    ...
    "abstractZh": "自回归视频扩散支持流式生成，通向长视频合成、视频 World Model 与交互神经游戏引擎，但推理时 KV cache 增长推高延迟与显存，限制时序上下文并损害长程一致性。作者识别跨帧近重复缓存键、缓慢演化查询/键造成的冗余注意力，以及长提示交叉注意力中每帧仅少数 token 重要。据此提出免训练框架 FAST-AR：TempCache 按时间对应压缩 KV cache；AnnCA 用 ANN 选择帧相关提示 token 加速交叉注意力；AnnSA 将自注意力限制到语义匹配的键。可与现有自回归扩散骨干及 World Model 兼容，端到端加速达 5–10 倍，视觉质量近乎不变，长 rollout 吞吐稳定且峰值显存近乎恒定。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "Fast-WAM 追问世界—动作模型是否必须在测试时做未来想象：研究能否在保持性能下跳过昂贵 rollout，以服务实时控制。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "10 pages, 5 figures. Accepted at ACM Multimedia 2026 (MM '26)",
    ...
    "abstractZh": "UAV-VLN 使空中智能体根据自我中心视觉观测，在开放 3D 环境中遵循自然语言指令。现有方法存在指令相关地标锚定弱、长时程历史利用不足、局部陷阱或重复探索下决策不稳等耦合问题。本文提出统一语义到决策框架：先将物体级语义与相对空间线索注入当前观测；再以相关性感知策略重加权完整历史缓冲，并将高相关帧转为结构化地标提示；最后以拓扑感知决策结合局部最优认知与组相对策略优化，奖励覆盖进度、目标、语义与路径合规。在 AerialVLN 与 OpenFly 上达到文中所述 SOTA。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2608.09564",
    "pdf": "https://arxiv.org/pdf/2608.09564"
  },
  {
    "id": "2608.06332",
    "nickname": "GeniWorld",
    ...
    "abstractZh": "通用机器人策略在复杂未见环境中鲁棒性仍有限，多样真实环境中扩展学习与评测成本高。动作条件 World Model 常动作可控性不足且 OOD 泛化差。本文提出 GeniWorld：基于预训练视频生成模型，用 URDF 渲染将数值动作转为视觉动作表示，实现空间锚定控制，并显式解耦本体运动学与环境动力学以减轻场景过拟合。自回归视频预测结合高频运动学控制，可与策略及人类遥操作闭环交互。即便仅在有限固定场景数据上训练，域内与对高度随机未见环境的零样本泛化均较强；还可作为策略评测器，并在有限真实演示下生成多样操作轨迹以提升下游策略。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_api",
    "arxiv": "https://arxiv.org/abs/2608.06332",
  ...
  },
  {
    ...
    "abstractZh": "大规模视频生成模型展现零样本视觉规划能力，但生成计划常违反时间一致性与物理约束，映射为可执行动作时失败。本文提出 GVP-WM：用学得的动作条件 World Model 将视频计划锚定为可行动作序列。测试时先由初始与目标观测生成视频计划，再经视频引导的潜空间配置将其投影到动力学可行的潜轨迹流形。锚定被表述为目标条件潜空间轨迹优化，在 World Model 动力学下联合优化潜状态与动作，并保持与视频计划的语义对齐。实验表明该方法能从违反物理约束的零样本图像到视频及运动模糊视频中恢复可行长时程计划，覆盖导航与操作仿真。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_api",
    "arxiv": "https://arxiv.org/abs/2602.01960",
    "pdf": "https://arxiv.org/pdf/2602.01960"
  },
  {
    "id": "2602.11291",
    "nickname": "H-WM",
    ...
    "abstractZh": "World Model 因能预测未来状态转移而成为机器人规划与控制的核心。现有方法常强调视频生成或自然语言预测，难以锚定到机器人动作且长时程误差累积；经典任务与运动规划在逻辑空间建模转移，可执行且长时程稳健，但通常独立于视觉感知。本文提出层次化 World Model（H-WM），在统一框架中联合预测逻辑与视觉状态转移：高层逻辑 World Model 与低层视觉 World Model 结合，以层次化输出为长时程任务提供稳定中间引导，减轻误差累积。在多种 VLA 控制策略上的实验表明其引导有效且具一般性。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_api",
    "arxiv": "https://arxiv.org/abs/2602.11291",
    "pdf": "https://arxiv.org/pdf/2602.11291"
  },
  {
    "id": "2608.12860",
    "nickname": "HumanoidVLN",
  ...
  },
  {
    ...
    "venue": "11 pages, 1 figure, 3 tables. Project page: https://condvln.github.io/",
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2608.17318",
  ...
  },
  {
    ...
    "abstractZh": "分散、部分可观测环境中，LLM 智能体常与伙伴或环境状态不对齐。LLawCo 让智能体反思失败、提炼「必要时说话」「等待伙伴」等高层次合作法则，再经监督微调写入思维链。作者构建基于 PARTNR 的大规模对话合作基准 PARTNR-Dialog；相对开源通信智能体，四类 LLM 骨干上 PARTNR-Dialog 平均成功率高 4.5%，TDW-MAT 高 6.8%。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "19 Pages, 7 Figures. Accepted in EMNLP 2026 Main. Project Page: https://kunyang-yu.github.io/LookStep/",
    ...
    "abstractZh": "VLN 要求具身智能体在未见环境中遵循自然语言指令。近期进展多由 MLLM 驱动，但现有方法仅监督专家下一步动作，需大量数据，并依赖认知地图、累积历史帧或外部 3D 工具维持状态，计算与记忆开销高。本文提出 LookStep：统一端到端结合语言中心未来状态建模与事件驱动滚动记忆，用语言标签为每个候选动作生成粗粒度导航进度与未来状态，并自主决定是否将观测写入带语义角色的有界滚动记忆。在 VLN-CE 上，相同训练设定下优于现有方法，R2R-CE Val-Unseen 成功率为 49.7%，记忆效率更高、数据用量更少。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2609.02350",
    "pdf": "https://arxiv.org/pdf/2609.02350"
  },
  {
    "id": "2601.17507",
    "nickname": "MetaWorld",
    ...
    "venue": "8 pages, 4 figures, Submitted to ICLR 2026 World Model Workshop",
    ...
    "abstractZh": "人形机器人 loco-manipulation 受语义-物理鸿沟制约：强化学习样本效率低、模仿学习泛化差、VLM 存在物理不一致。本文提出层次化 World Model MetaWorld，通过专家策略迁移整合语义规划与物理控制：任务解耦为 VLM 驱动的语义层与在紧凑状态空间运行的潜动力学模型；动态专家选择与运动先验融合利用预训练多专家策略库作为可迁移知识，经两阶段框架在线适应。VLM 将指令映射为可执行技能，绕过符号接地。Humanoid-Bench 上在任务完成与运动连贯性上优于基于 World Model 的强化学习。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_api",
    "arxiv": "https://arxiv.org/abs/2601.17507",
    "pdf": "https://arxiv.org/pdf/2601.17507"
  },
  {
    "id": "2609.06251",
    "nickname": "MobileVLA-R1 2.0",
    ...
    "abstractZh": "MobileVLA-R1 2.0 用监督思维链与强化学习对齐推理到动作，再经推理条件动作解码器输出移动机器人任务级目标。在 VLN-CE、四足与 Unitree Go2/G1 真机上，相对 MobileVLA-R1 平均成功率提升，并改善长时程指令跟随。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2609.06251"
  },
  {
    "id": "2606.04463",
    "nickname": "OSCAR",
    ...
    "venue": "Project page: https://wuzy2115.github.io/oscar-project-page/",
    ...
    "abstractZh": "本文提出 OSCAR：精确的动作条件视频 World Model，可跨不同机器人本体泛化并用于策略评测。现有视频 World Model 面临训练数据场景多样性不足、动作跟随不准、跨本体泛化差。作者以大规模标准化管线整理、过滤并去重机器人与自我中心人类数据，并以 2D 运动学骨架渲染作为可泛化到不同机械臂甚至人手的统一条件表示，在单块 GH200 上微调 Cosmos-Predict2.5-2B。相对更大模型或更多 GPU 的基线，动作跟随、外观质量与运动一致性显著提升；部署于 RoboArena 时，虚拟策略评测与真实评测显著相关。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_api",
    "arxiv": "https://arxiv.org/abs/2606.04463",
  ...
  },
  {
    ...
    "abstractZh": "VLN 要求智能体解释自然语言指令，并根据时序视觉观测预测动作。将多模态大语言模型适配到 VLN 需要视觉-语言对齐、紧凑时序输入、动作空间锚定及目标硬件上的稳定训练。本文提出基于 OpenPangu-7B 的离线动作预测系统 PGN：先以 Q-Former 与两层 MLP 对齐冻结的 EVA-ViT-G/14 与语言骨干，再以五观测窗口、随 epoch 变化的时序采样及先推理后动作格式适配专家轨迹，并更新结构 token 嵌入与 LoRA。在八张昇腾 910B 上以混合精度与 DeepSpeed ZeRO-2 训练。500 条留出专家轨迹的教师强制开环评测中，V9 的 NAM 为 62.29%、NER 为 100%，衡量离线专家动作对齐而非闭环导航成功。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2607.17806"
  },
  {
    "id": "2603.09030",
    "nickname": "PlayWorld",
    ...
    "venue": "Website: https://robot-playworld.github.io/",
    ...
    "abstractZh": "动作条件视频模型有望构建可直接从数据改进的通用机器人仿真器，但即便在大规模机器人数据上训练，现有 SOTA 视频模型仍难以预测操作所需的物理一致机器人-物体交互。本文提出 PlayWorld：从交互经验训练高保真视频世界仿真器的简单、可扩展、全自主管线，据称首次完全从无监督机器人自博弈学习，从而可扩展采集并捕捉长尾物理交互。多样操作任务上，其对接触丰富交互的预测优于在人类采集数据上训练的 World Model；细粒度失败预测与策略评测相对人类数据最高提升 40%；并支持在 World Model 中做强化学习，实机部署成功率提升 65%。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2603.09030"
  },
  {
    "id": "2601.03782",
    "nickname": "PointWorld",
    ...
    "abstractZh": "人类能从一瞥与设想的身体动作预判 3D 世界如何响应。本文提出大型预训练 3D World Model PointWorld：在共享 3D 空间中以 3D 点流统一状态与动作，给定一两张 RGB-D 与低层动作指令序列，预测响应这些动作的逐像素 3D 位移，从而直接条件于机器人几何并跨本体整合学习。训练数据覆盖真实与仿真开放世界操作，约 200 万条轨迹、500 小时，涵盖单臂 Franka 与双臂人形。大规模实证研究提炼骨干、动作表示与目标等设计原则。实时（0.1s）推理可嵌入 MPC；单一预训练检查点使真实 Franka 在无演示、无后训练、仅一张野外图像下完成刚体推、可变形与铰接物操作及工具使用。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2601.03782"
  },
  {
    "id": "2608.22678",
    "nickname": "RACO",
    ...
    "pdf": "https://arxiv.org/pdf/2608.22678"
  },
  {
    "id": "2608.09467",
    "nickname": "RecoverFly",
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2608.09467",
    "pdf": "https://arxiv.org/pdf/2608.09467"
  },
  {
    "id": "2609.03906",
    "nickname": "2609.03906",
    ...
    "abstractZh": "连续环境视觉语言导航（VLN-CE）要求智能体在未见环境中跟随自然语言指令。现有模仿学习在闭环中困难：行为克隆存在分布偏移，DAgger 在轨迹偏离后专家动作变得含糊。直接在微动作空间做强化学习则因奖励稀疏而不够样本高效。本文将 VLN-CE 重构为分层马尔可夫决策过程，用拓扑图将环境抽象为前沿节点上的宏动作，并以无需训练的低层控制器作为状态转移，以便压缩决策时域、使闭环强化学习可行。进而提出动作感知价值头，在动态前沿动作空间下评估状态价值，支撑基于图的 PPO。在 R2R-CE 与 RxR-CE 上取得当时最优。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2609.03906"
  },
  {
    "id": "2602.14979",
    "nickname": "RynnBrain",
    ...
    "abstractZh": "具身社区缺少在真实时空动力学中统一感知、推理与规划的物理接地基础模型。RynnBrain 是开源时空基础模型，强化自我中心理解、时空定位、物理接地推理与物理感知规划；提供 2B / 8B / 30B-A3B MoE 及导航、规划、VLA 与空间推理等后训练变体。在 20 个具身与 8 个通用视觉基准上明显优于既有具身基础模型，并可用作可高效适应的预训练骨干。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "层次化系统里 VLM 与 VLA 之间若只有自然语言任务指令，高层推理很难转向低层行为。Steerable Policies 在子任务、运动与接地像素坐标等多抽象层级的合成命令上训练 VLA。用学得的高层具身推理器或即插即用 VLM（上下文学习推理命令抽象）来控制该策略时，真机操作在泛化与长时程上优于先前具身推理 VLA 与 VLM 层次基线。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2602.13193",
  ...
  },
  {
    ...
    "abstractZh": "本文研究人形机器人在杂乱室内的导航。不同于二维路径规划，杂乱场景中的人形穿越需要几何感知的全身适应，包括协调手臂放置、躯干调整与步态调制。TANGO 是首个面向语言条件人形穿越的全身视觉语言导航框架：由自然语言指令与自我中心 RGB 直接预测 29-DoF 关节空间动作。训练完全在仿真中进行，借助全局路径规划、运动学全身运动生成、障碍感知运动编辑与强化学习跟踪合成无碰撞行为。仿真中取得视觉语言导航最优，并在需协商障碍的场景上优于强模块化基线；在 Unitree G1 上零样本部署，无需真实导航数据即可实现语言引导穿越。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "TiPToP 是模块化开放词汇操作规划系统：把开放词汇接地与经典任务—运动规划组合，并作为可调用后端供更高层物理 Agent 使用。Physical Agency 一文将其当作冻结工具而非整系统。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Accepted at ICLR 2026. Code, datasets, and models are available at https://github.com/szegedai/world",
    ...
    "abstractZh": "生成式序列模型通常在自然或形式语言样本上训练，关键问题是基于样本的训练能否捕捉这些语言的真实结构，即所谓 world model。理论表明至多可期望健全性——生成合法序列，但不一定覆盖全部。本文以国际象棋为对象，用对抗序列生成检验模型是否健全：对手构造合法序列以迫使模型预测非法着法，并分析失败模式与训练选择。在随机与高质量对局、多种配方的大量象棋模型上评估，发现无一健全，但部分技术与数据选择能显著改善健全性。棋盘状态探测还表明，多数模型中提取的棋盘状态对下一 token 预测并无因果作用。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "VLA-Precision 用非对称共引导做高效真机在线强化学习，缓解不可靠价值信号与大 VLA 吞吐瓶颈。在四类九项高精度化学任务、四种本体上，平均成功率 98.3%，并报告显著吞吐提升。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "该文系统研究层次化 VLA Agent：高层 VLM 规划器分解任务，低层 VLA 执行。在统一 options 框架下比较规划器、控制器、切换与记忆设计，并在仿真与真实 ALOHA 上表明原则化层次显著优于平坦 VLA 或朴素层次。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2606.10267",
  ...
  },
  {
    ...
    "abstractZh": "World Action Models are Zero-shot Policies 主张世界—动作模型本身即可作为零样本策略：在学得的动作条件动力学上直接解码控制，而无需单独策略头。",
    "highlightsZh": [
  ...
  {
    "id": "2605.00080",
    "nickname": "World Model for Robot Learning",
    ...
    "abstractZh": "World Model 是动作条件下环境如何演化的预测表示，已成为机器人学习的核心，支撑策略学习、规划、仿真、评估与数据生成，并随基础模型与大规模视频生成迅速发展。文献在架构、功能角色与具身应用上仍较分散。本文从机器人学习视角综述：考察 World Model 如何与策略耦合、如何作为强化学习与评估的学习仿真器，以及机器人视频 World Model 如何从想象生成走向可控、结构化与基础模型尺度；并连接到导航与自动驾驶，总结数据集、基准与评估协议。综述澄清范式与应用，指出挑战与未来方向，并将持续更新配套 GitHub 仓库。",
    "highlightsZh": [
  ...
  {
    "id": "2606.00113",
    "nickname": "World Models for Robotic Manipulation",
    ...
    "abstractZh": "机器人操作依赖在执行前预判动作如何改变物体、接触与场景几何。学习到的 World Model 预测干预下的任务相关未来，但该术语已涵盖潜在动力学、动作条件视频生成、三维与四维场景预测、物理仿真器及 VLA 内部预测模块。本文以预测何种表示、如何连接动作、何时用于学习流水线组织综述，将 World Model 定义为动作条件预测系统，并与感知、逆模型、策略、奖励与价值函数区分。归纳五类表示与功能分类，覆盖预训练、后训练与推理适应，回顾 34 个操作数据集并综合评估协议。综述表明 World Model 正演变为预测基础设施，并指出接触建模、幻觉控制、动作对齐与闭环评测等挑战。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2606.00113"
  },
  {
    "id": "2602.02454",
    "nickname": "World-Gymnast",
    ...
    "venue": "https://world-gymnast.github.io/",
    ...
    "abstractZh": "与物理世界交互的成本制约机器人学习：监督微调受专家数据量限制，软件仿真器则有操作域的仿真到真实差距。本文提出 World-Gymnast：在动作条件视频 World Model 中展开 VLA 策略，并用 VLM 对轨迹打分以做强化学习微调。在 Bridge 机器人上，相对监督微调最高约 18 倍、相对软件仿真器最高约 2 倍。还展示在多样语言指令与新场景上训练、在新场景做测试时训练，以及在线迭代改进 World Model 与策略。结果表明，在云端学习 World Model 并训练策略或有助于弥合仅能完成演示与可在家庭中工作的机器人之间的差距。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_api",
    "arxiv": "https://arxiv.org/abs/2602.02454",
  ...
  },
  {
    ...
    "abstractZh": "World-Language-Action（WLA）用自回归 Transformer 统一世界建模、语言推理与动作合成：高层意图以文本子任务形式引导动力学与动作，相对纯 VLA 更能利用无动作标注的跨本体视频。原型在仿真与真机多任务、长时程上报告强成功。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "π₀.₇ 是可转向的通才机器人基础模型，强调涌现能力与更丰富的命令结构，供层次化控制与具身推理使用。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "18 pages, 5 figures. Project page: https://tau0-vla.github.io/",
    ...
    "abstractZh": "长时程机器人操作既要可靠执行单项技能，也要在延展任务中连贯编排。多数层次化 VLA 仅用单次前向完成决策，难以把额外算力投向困难或关键选择。本文提出 τ₀-VLA：将高层子任务生成表述为可随算力扩展的推理，并由 World Model 引导测试时计算。高层策略利用执行记忆生成子任务，必要时搜索备选后再提交；低层策略在多种本体上执行。模型在 40115 小时异构真实数据上多模态共训。域内与分布偏移下，增加测试时计算显著提升下一子任务预测精度，并转化为长时程操作闭环成功率提高。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "具身智能需要智能体感知、行动并预判动作如何改变未来世界状态。World Model 作为捕捉环境动力学的内部仿真器，支持前向与反事实展开。本综述提出具身人工智能中 World Model 的统一框架：形式化问题与学习目标，并沿功能（决策耦合相对通用）、时间建模（序列仿真推断相对全局差分预测）、空间表示（全局潜向量、token 特征序列、空间潜网格、分解渲染）三轴分类。系统整理机器人、自动驾驶与通用视频的数据与指标，并定量比较前沿模型。开放挑战包括统一数据稀缺、需超越像素保真的物理一致性评估、性能与实时控制算力权衡，以及长时程一致性与误差累积。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "视觉语言动作模型（VLA）旨在连接数字知识与物理交互，但基础 VLA 受大规模架构的高昂算力与数据需求制约。近期工作关注提升效率，却缺少统一框架。本综述首次沿模型—训练—数据全流水线全面评述高效 VLA，将技术归为三柱：高效模型设计（架构与压缩）、高效训练（降低学习算力）、高效数据采集（缓解机器人数据获取与利用瓶颈）。在此框架下批判性回顾前沿方法，总结代表性应用、关键挑战与未来路线图，并维护持续更新的项目页。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2510.24795",
  ...
  },
  {
    ...
    "abstractZh": "基于 World Model 的强化学习为自动驾驶提供先学潜在动力学再用其训练规划策略的路径。预训练—微调常用于加速，但在新任务在线交互中朴素初始化可能导致性能剧降。作者识别两大根因：规划策略不匹配与动力学模型不匹配，均源于分布偏移，且微调策略的选择至关重要。据此提出 AdaWM：先量化不匹配以指导微调，再以低秩更新按需对齐策略或模型。在具有挑战性的 CARLA 驾驶任务上，AdaWM 显著改善微调，使规划更稳健高效。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2501.13072"
  },
  {
    "id": "2503.18938",
    "nickname": "AdaWorld",
    ...
    "abstractZh": "World Model 旨在学习受动作控制的未来预测，对智能体发展至关重要。多数现有方法依赖大量动作标注与昂贵训练，难以通过有限交互适应动作异构的新环境。AdaWorld 在预训练中纳入动作信息：以自监督从视频提取潜在动作，捕捉帧间最关键转移，并训练条件于这些潜在动作的自回归 World Model。该范式使模型高度可适应，即便交互与微调有限也能高效迁移并学习新动作。跨多种环境的实验表明，AdaWorld 在仿真质量与视觉规划上均更优。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2503.18938"
  },
  {
    "id": "2512.11362",
    "nickname": "2512.11362",
    ...
    "venue": "project page: https://suyuz1.github.io/VLA-Survey-Anatomy/",
    ...
    "abstractZh": "视觉语言动作（VLA）模型使机器人理解指令并与物理世界交互，模型与数据迅速增长。本综述按研究者学习路径组织：从任意 VLA 的基本模块，经关键里程碑，再深入近期前沿的核心挑战。主要贡献是拆解五大挑战：表示、执行、泛化、安全、数据集与评估，对应通才智能体从感知—动作环、跨本体与环境扩展，到可信部署并由数据基础设施支撑的路线。对每一挑战回顾现有方法并指出未来机会，兼作新手指南与资深路线图，并维护持续更新的项目页。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2512.11362",
    "pdf": "https://arxiv.org/pdf/2512.11362"
  },
  {
    "id": "2507.19468",
    "nickname": "Back to the Features",
    ...
    "abstractZh": "本文提出 DINO-world，一个在 DINOv2 潜空间中预测未来帧的强通用视频 World Model。它借助预训练图像编码器，并在大规模未策展视频上训练未来预测器，从而学习驾驶、室内场景到仿真环境等多样场景的时间动力学。DINO-world 在分割与深度预测等视频预测基准上优于先前模型，并展现对直觉物理的较强理解。还可在观测—动作轨迹上微调预测器；得到的动作条件 World Model 能在潜空间仿真候选轨迹以用于规划。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2507.19468"
  },
  {
    "id": "2507.15597",
    "nickname": "Being-H0",
    ...
    "abstractZh": "Being-H0 从大规模人类视频做视觉—语言—动作预训练，把自我中心人类行为迁到机器人策略，降低对机器人轨迹的依赖。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "在边缘设备部署强大 VLA 受其巨大规模限制。本文从部署导向出发，通过模型设计与优化追求效率，而非仅依赖事后压缩。BitVLA 是面向机器人操作的原生 1-bit VLA，全部参数为三元取值 {-1,0,1}，基于公开的 1-bit 大语言模型 BitNet b1.58 2B4T。为降低视觉骨干显存，提出 Quantize-then-Distill：将全精度视觉编码器压缩为 1.58-bit 权重，并由全精度教师引导表示对齐。在仿真基准与真实任务上匹配全精度 OpenVLA-OFT，同时模型显存降低 11.0 倍、端到端延迟降低 4.4 倍。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2506.07530",
    "pdf": "https://arxiv.org/pdf/2506.07530"
  },
  {
    "id": "2512.11769",
    "nickname": "BLURR",
    ...
    "venue": "10 pages, 3 figures. Code and integration scripts will be released at this http URL: https://github.com/JijiKing-Sam/BLU",
    ...
    "abstractZh": "VLA 能实现出色的零样本操作，但其推理栈对网页演示或消费级 GPU 上的高频控制往往过重。BLURR 是可插入现有 VLA 控制器的轻量推理包装，无需重训或更改检查点。以 pi-zero 为实例，它保留原观测接口，并结合指令前缀键值缓存、混合精度与单步展开调度以降低逐步计算。在基于 SimplerEnv 的评估中，成功率与原控制器相当，同时显著降低有效浮点运算与墙钟延迟。作者还构建可实时切换控制器与推理选项的交互网页演示，凸显其在紧计算预算下部署现代 VLA 的实用性。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2512.11769",
    "pdf": "https://arxiv.org/pdf/2512.11769"
  },
  {
    "id": "2502.14420",
    "nickname": "ChatVLA",
    ...
    "abstractZh": "人类具有感知、理解并与物理世界交互的统一认知。对现有 VLA 训练范式的分析揭示两大挑战：虚假遗忘（机器人训练覆盖视觉—文本对齐）与任务干扰（控制与理解联合训练时相互损害）。ChatVLA 采用分阶段对齐训练，在掌握控制后再增量融入多模态数据，并以 Mixture-of-Experts 降低任务干扰。它在视觉问答上具竞争力，多模态理解基准显著优于当时 VLA 方法：MMMU 约为六倍，MMStar 为 47.2%，且设计比 ECoT 更省参数；并在 25 项真实操作任务上优于 OpenVLA 等。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Accepted to NeurIPS 2025, Project Page: https://jiutian-vl.github.io/CogVLA-page",
    ...
    "abstractZh": "基于预训练 VLM 的 VLA 需要大量后训练，算力开销限制可扩展性。CogVLA 以指令驱动路由与稀疏化提升效率与性能，采用三阶段架构：EFA-Routing 将指令注入视觉编码器，聚合压缩双流视觉标记；LFP-Routing 向语言模型引入动作意图并剪除无关视觉接地标记；CAtten 结合因果视觉—语言注意力与双向动作并行解码。在 LIBERO 与真实机器人任务上分别取得 97.4% 与 70.0% 成功率，相对 OpenVLA 训练成本降低 2.5 倍、推理延迟降低 2.8 倍。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "NVIDIA Cosmos 世界基础模型平台面向物理人工智能，提供可微调的视频世界模型、数据与工具。本包 OSS 已收录 cosmos / predict 仓库，此处补平台论文卡片。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "通才机器人策略已能执行广泛操作技能，但评估并改进其对陌生物体与指令的能力仍难：真实展开与带专家标注的纠错数据都缓慢昂贵。World Model 可在想象空间中展开策略，但需支持多视角预测、细粒度动作控制与长时程一致交互。本文提出可控多视角 World Model：以位姿条件记忆检索保持长时程一致性，并以帧级动作条件实现精确控制。在 DROID（95k 条轨迹、564 个场景）上训练，可在新场景与新相机位下生成逾 20 秒时空一致轨迹。无需真实展开即可准确排序策略表现；在想象中合成成功轨迹做监督微调，使策略成功率提升 44.7%。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "IROS-MoMA3 Workshop 2024",
    ...
    "abstractZh": "VLM 有望缓解机器人数据稀缺并支撑可泛化视觉运动策略，但如 OpenVLA 等大规模模型难以部署在资源受限的移动操作平台。Edge VLA（EVLA）旨在显著提升 VLA 推理速度，在保持表示能力的同时实现边缘设备实时性能。两点创新：取消末端执行器位置预测的自回归要求，推理加速约 7 倍；利用小语言模型（SLM），以更低算力获得与更大模型相当的训练表现。早期结果显示 EVLA 训练特性与 OpenVLA 相当，同时推理速度与显存效率有实质提升。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "以策略强化学习训练的 VLA 能编码复杂行为而不显式建模环境动力学，但其是否隐式学习 World Model 仍不清楚。本文对状态表示做嵌入算术，以探测 OpenVLA 是否包含状态转移的潜在知识：测量连续环境状态嵌入之差，并检验该转移向量能否从中间激活中恢复。在各层激活上训练线性与非线性探针，发现对状态转移的预测能力在统计上显著超过嵌入基线，表明 OpenVLA 编码了内部 World Model 而非探针本身学会转移。更早检查点显示该 World Model 随训练进展出现。并概述用稀疏自编码器分析该模型的流水线。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2509.24559"
  },
  {
    "id": "2509.13095",
    "nickname": "2509.13095",
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2509.13095",
    "pdf": "https://arxiv.org/pdf/2509.13095"
  },
  {
    "id": "2506.24113",
    "nickname": "Epona",
    ...
    "abstractZh": "扩散模型在视频生成上视觉质量出色，适合自动驾驶 World Model，但现有视频扩散 World Model 难以灵活长度、长时程预测并整合轨迹规划，因其对固定长度帧序列做全局联合分布建模。Epona 是自回归扩散 World Model：解耦时空分解将时间动力学与细粒度未来世界生成分开，模块化轨迹与视频预测将运动规划与视觉建模端到端结合。架构支持高分辨率长时生成，并以链式前向训练缓解自回归误差累积。实验显示弗雷歇视频距离改进 7.4%、预测时长更长，并作为实时运动规划器在 NAVSIM 上优于强端到端规划器。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "长时程操作对 VLA 仍难，现有模型常出现阶段幻觉，借粗糙评估捷径虚报进度。EvoVLA 含 SAR（三联对比与 Gemini 难负例）、POE（以物体-夹爪相对位姿驱动好奇）及选择性上下文保留与门控融合的长时程记忆。Discoverse-L 上平均成功率较 OpenVLA-OFT 高 10.2 个百分点达 69.2%，样本效率约 1.5 倍，阶段幻觉由 38.5% 降至 14.8%；真机四任务平均 54.6%。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2511.16166",
  ...
  },
  {
    ...
    "venue": "Accepted to MobieSec 2025 (poster session)",
    ...
    "abstractZh": "智慧农业常用 RGB 相机与机械臂，但对色调、光照与噪声等光度扰动敏感，对抗攻击下易失灵。本文基于 OpenVLA-OFT 提出可解释、对抗鲁棒的 VLA，并集成 Evidence-3 模块检测光度扰动，用自然语言说明成因与影响。实验显示相对基线，当前动作 L1 损失降 21.7%、后续动作 L1 损失降 18.4%，提升对抗条件下的动作预测精度与可解释性。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2512.11865",
    "pdf": "https://arxiv.org/pdf/2512.11865"
  },
  {
    "id": "2501.09747",
    "nickname": "FAST",
    ...
    "abstractZh": "FAST 提出高效的 VLA 动作分词，降低动作序列的 token 数与训练 / 推理成本，成为后续开源 VLA 栈的常见组件。",
    "highlightsZh": [
      "方法：为 VLA 设计更高效的动作分词。",
  ...
  },
  {
    ...
    "abstractZh": "FCRF 提出灵活建构主义反思，用于 LLM 长时程家用任务规划的自主纠错。针对既有自我反思机制僵硬，借鉴人类认知适应，使长时程家务执行更可靠。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2507.14975",
    "pdf": "https://arxiv.org/pdf/2507.14975"
  },
  {
    "id": "2502.19645",
    "nickname": "Fine-Tuning Vision-Language-Action Models",
    ...
    "venue": "Accepted to Robotics: Science and Systems (RSS) 2025. Project website: https://openvla-oft.github.io/",
    ...
    "abstractZh": "近期 VLA 依托预训练视觉语言模型与多样机器人数据，具备执行与语义泛化能力，但对新机身常需微调且策略不清。本文以 OpenVLA 比较动作解码、表示与目标，提出并行解码、动作分块、连续动作与 L1 回归的 OFT。LIBERO 上平均成功率由 76.5% 提至 97.1%，吞吐约 26 倍；真机双臂 ALOHA 上优于默认配方的 π0、RDT-1B 及从零训练的 Diffusion Policy 与 ACT，最高约 15 个百分点。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Project page: see https://sharinka0715.github.io/FlowDreamer/",
    ...
    "abstractZh": "本文研究面向机器人操作、以历史帧与动作为条件预测未来观测的 RGB-D 世界模型。不同于把动力学隐含在单一渲染模型中，FlowDreamer 用三维场景流作显式运动表示：先以 U-Net 由历史帧与动作预测场景流，再用扩散模型据此生成未来帧，并端到端训练。在四个涵盖视频预测与视觉规划的基准上，相对其他 RGB-D 世界模型，语义相似高 7%、像素质量高 11%、操作成功率高 6%。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2505.10075"
  },
  {
    "id": "2509.23655",
    "nickname": "Focusing on What Matters",
    ...
    "venue": "Presented at 9th Conference on Robot Learning (CoRL 2025), Seoul, Korea",
    ...
    "abstractZh": "VLA 常复用预训练 VLM 输出机器人动作，但视觉输入的 tokenization 计算代价过高。本文提出 Oat-VLA，即面向物体与智能体的分词，把归纳偏置对准场景物体及智能体自身视觉信息，从而把视觉 token 压到极少而不牺牲性能。LIBERO 上收敛至少比 OpenVLA 快一倍，并在多样真机抓放任务上优于 OpenVLA。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2509.23655",
  ...
  },
  {
    ...
    "abstractZh": "GAIA-2 是可控多视角生成式驾驶世界模型，为 GAIA-1 后续。官方权重仍未开放；社区仅有架构级复现。本包补上论文卡片以对照缺口表。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "Gemini Robotics 把 Gemini 类多模态模型带入物理世界，训练双系统视觉—语言—动作能力，用于真实机器人操作与推理。作为工业闭源 / API 向地标，它常被层次化 Agent 论文当作低层后端。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "通才机器人需要灵活身体与智能「心智」。GR00T N1 是开放的人形 VLA：系统 2 的视觉—语言模块解释环境与指令，系统 1 的扩散 Transformer 实时生成流畅动作，两端到端联合训练。数据混合真机轨迹、人类视频与合成数据。仿真多本体上优于模仿学习基线，并在 Fourier GR-1 人形上做语言条件双臂操作，数据效率高。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Published at ICCV 2025. Project page: https://gaussian-world-model.github.io/",
    ...
    "abstractZh": "在学得世界模型中训策略可减少真机交互，但图像世界模型即使经大规模视频预训练也缺稳健几何。Gaussian World Model（GWM）在动作下推断高斯基元传播以重建未来，核心为潜空间 DiT 与三维变分自编码器，并用 Gaussian Splatting 做场景级重建。它可通过自监督未来预测增强模仿表征，也可作神经仿真器支持基于模型的强化学习；仿真与真机显示其能按多样动作精确预测未来，并据此训出明显更优的策略。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2508.17600"
  },
  {
    "id": "2502.19417",
    "nickname": "Hi Robot",
  ...
  },
  {
    ...
    "abstractZh": "本文改进 Transformer 世界模型：Dyna with warmup（模型够好后才用想象数据）、码字固定的最近邻图像块 tokenizer，与联合推理下一时刻全部 token 的 block teacher forcing。Craftax-classic 上 100万步达 69.66%，超过 DreamerV3 的 53.2% 并首次超过人类 65.0%；亦在 Craftax-full、MinAtar 与三款双人游戏上初步验证。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2502.01591",
  ...
  },
  {
    ...
    "venue": "Presented at the Robotics: Science and Systems (RSS) 2025 Workshop on Resilient Off-road Autonomous Robotics (ROAR)",
    ...
    "abstractZh": "无先验地图的移动机器人须靠传感器建世界模型，障碍判定常不一致，代价图在障碍与自由空间间翻转。VEH 要求轨迹在历史世界模型中皆安全；另有按改道惩罚调节点代价的 PEH、GEH、GEGRH：PEH 在分歧点做子搜索，后两者推迟到进入目标区，GEGRH 再按分歧节点修订图。PEH/GEH 虽更乐观但规划超 1 秒；越野场上 GEGRH 比 VEH 代价更低、平均更快，比单假设搜索更保守、耗时略增。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2509.26339",
    "pdf": "https://arxiv.org/pdf/2509.26339"
  },
  {
    "id": "2505.11528",
    "nickname": "LaDi-WM",
    ...
    "abstractZh": "预测操纵可借未来状态提升策略，但世界模型生成高质量像素级交互仍难。LaDi-WM 用扩散在潜空间预测未来状态，依托与预训练 Visual Foundation Models 对齐的表征：DINO 几何特征与 CLIP 语义特征。作者发现预测潜空间演化比直接预测像素更易学、更可泛化。其上设计扩散策略，迭代融入预报状态以精炼动作。LIBERO-LONG 上策略提升 27.9%，真机约 20%，并展现真机泛化。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2505.11528"
  },
  {
    "id": "2506.13751",
    "nickname": "LeVERB",
    ...
    "abstractZh": "LeVERB 做人形全身控制的潜在视觉—语言指令：把语言接到全身运动潜空间，而非仅机械臂 VLA。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2506.13751"
  },
  {
    "id": "2503.17309",
    "nickname": "LLM+MAP",
    ...
    "abstractZh": "LLM+MAP 用大语言模型与 PDDL 做双臂长时程任务规划：既有工作多重双手技能，本文补上长时程任务层，用上下文学习与规划域定义协调双手时空。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2503.17309"
  },
  {
    "id": "2510.23509",
    "nickname": "2510.23509",
    "title": "Logic-Guided Socially-aware Robot Navigation World Model",
    "authors": [],
    "year": 2025,
    "published": "2025-01-01",
    "tags": [
    ...
    "venue": "The authors have decided to withdraw this manuscript due to concerns regarding its current scope, framing, and presentat",
    ...
    "abstractZh": "社交机器人导航日益依赖大语言模型做推理与路径规划，但仅靠 LLM 在动态人群中常不安全、缺物理接地与逻辑一致性。NaviWM 将 LLM 推理与结构化世界模型及逻辑驱动思维链结合：时空世界模型刻画智能体位置、速度与活动；演绎模块引导多步逻辑推断，使决策满足个人空间、避碰与时序等约束。社交规范编码为一阶逻辑以便解释与验证。实验显示成功率提升、社交违规减少，尤其在拥挤环境。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2510.23509",
  ...
  },
  {
    ...
    "abstractZh": "LUMOS 是语言条件多任务模仿学习框架：在学得世界模型潜空间中经长时程 rollout 练习技能，并零样本迁到真机。潜空间 on-policy 学习可缓解离线模仿的策略诱导分布偏移。它从非结构化玩耍数据学习，事后语言标注不足 1%，测试时仍可用语言指挥。训练结合潜空间规划、图像与语言事后目标重标注，并优化潜空间多步内在奖励。CALVIN 链式多任务上优于可比方法；据称是首次在离线世界模型中学习真机语言条件连续视觉运动控制。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2503.10370",
    "pdf": "https://arxiv.org/pdf/2503.10370"
  },
  {
    "id": "2512.15692",
    "nickname": "mimic-video",
    "title": "mimic-video: Video-Action Models for Generalizable Robot Control Beyond VLAs",
    "authors": [
      "Jonas Pai",
      "Liam Achenbach",
      "Victoriano Montesinos et al."
    ],
    "year": 2025,
    "published": "2025-01-01",
    "tags": [
    ...
    "abstractZh": "mimic-video 提出视频—动作模型（VAM），主张在 VLA 之外用视频—动作联合建模获得更可泛化的机器人控制。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2512.15692"
  },
  {
    "id": "2504.08388",
    "nickname": "MineWorld",
    ...
    "abstractZh": "世界建模对智能体与人交互、在动态环境中运作至关重要。MineWorld 是 Minecraft 上的实时可交互世界模型，由视觉—动作自回归 Transformer 驱动：用图像与动作 tokenizer 把场景和动作编成离散 token 并交错拼接，以下一 token 预测同时学习状态与动作条件。推理并行解码每帧空间冗余 token，不同规模可达每秒 4 至 7 帧。评测兼顾视觉质量与动作遵从，并显著优于当时开源扩散世界模型。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2504.08388"
  },
  {
    "id": "2512.13030",
    "nickname": "Motus",
    ...
    "abstractZh": "Motus 提出统一的潜在动作世界模型，把动作与未来预测放在同一潜空间，衔接世界建模与策略。",
    "highlightsZh": [
      "方法：统一潜在动作空间中的世界模型。",
    ...
    "pdf": "https://arxiv.org/pdf/2512.13030"
  },
  {
    "id": "2502.19902",
    "nickname": "Optimus-2",
  ...
  },
  {
    ...
    "abstractZh": "Phoenix 用基于运动的自我反思，把多模态模型的语义反思翻译成细粒度动作纠正。针对「知道失败了但不知如何改动作」的鸿沟，用运动指令连接语义反思与控制修正。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2504.14588",
    "pdf": "https://arxiv.org/pdf/2504.14588"
  },
  {
    "id": "2509.19012",
    "nickname": "Pure Vision Language Action (VLA) Models",
    ...
    "abstractZh": "Vision-Language-Action（VLA）把 VLM 从被动序列生成转为复杂动态环境中的主动操作与决策智能体。本综述梳理先进 VLA 方法，给出分类并系统回顾：按自回归、扩散、强化学习、混合与专用等范式分析动机、策略与实现，并介绍基础数据集、基准与仿真平台。在当前图景上讨论挑战与未来方向。综合三百余项近期研究，勾勒可扩展、通用 VLA 与可泛化机器人的机遇与难点。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2509.19012",
  ...
  },
  {
    ...
    "abstractZh": "REFLEX 赋予 LLM 元认知推理，做反思式零样本机器人规划：不停留在静态提示行为，而用类似人类的元认知与创造性解题提升复杂任务上的零 / 少样本规划。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2505.14899"
  },
  {
    "id": "2505.13934",
    "nickname": "RLVR-World",
    ...
    "abstractZh": "世界模型按动作预测状态转移，但最大似然等标准目标常与精度、感知质量等任务指标不对齐。RLVR-World 用带可验证奖励的强化学习（RLVR）直接按这些指标优化世界模型：虽把建模写成对分词序列的自回归预测，却以解码后预测的指标作可验证奖励。在语言与视频世界模型上，覆盖文本游戏、网页导航与机器人操作，均获显著提升。作者认为 RLVR 可作为生成模型更广泛的后训练范式。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "机器人走向复杂多模态操作时，融合先进 VLM 是关键，但在三维环境中融合深度与 RGB、并按语言指令执行仍困难。RoboFlamingo-Plus 在 RoboFlamingo 上引入深度：用预训练 Vision Transformer 与重采样融合 RGB 与深度并对齐语言；以预训练 resampler 提取深度特征，再用交叉注意力整合。从而更好理解三维环境并完成语言引导任务。实验显示操作性能较现有方法提升约 10%–20%。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2503.19510",
    "pdf": "https://arxiv.org/pdf/2503.19510"
  },
  {
    "id": "2501.06605",
    "nickname": "RoboHorizon",
    ...
    "abstractZh": "长时程操作中表示与策略学习困难，基于模型的视觉强化学习仍受稀疏奖励与复杂视觉困扰。本文提出 RSPA 流程与 RoboHorizon：预训练 LLM 按语言指令为多阶段子任务生成稠密奖励；关键帧发现接入多视角掩码自编码器；再构建机器人世界模型，用强化学习规划执行。RLBench 4 个短时程任务成功率高 23.35%，6 个长时程加 FurnitureBench 3 个装配任务高 29.23%。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "RoboMonkey 扩展 VLA 的测试时采样与验证：对候选动作做缩放采样并由验证器筛选，把 Agent 式 test-time compute 接到策略。层次化编排论文常引用它作为验证模块。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2506.17811",
    "pdf": "https://arxiv.org/pdf/2506.17811"
  },
  {
    "id": "2511.07416",
    "nickname": "2511.07416",
    ...
    "venue": "Project page: https://pointscoder.github.io/PhysWorld_Web/",
    ...
    "abstractZh": "PhysWorld 让机器人从视频生成中经物理世界建模学习。近期视频生成模型可由语言与图像合成逼真演示，但把像素运动直接重定向到机器人常忽略物理、导致操作不准。给定单图与任务指令，方法生成任务条件视频并重建底层物理世界，再以物体中心残差强化学习把视频运动落到物理可执行动作。该协同无需真机数据采集，实现零样本可泛化操作；多样真机任务上操作精度较先前方法显著提升。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "学习稳健可泛化的世界模型对真实环境中高效可扩展机器人控制至关重要。本文提出刻画复杂、部分可观测且随机动力学的世界模型框架，采用双自回归机制与自监督训练，在不依赖领域特定归纳偏置的情况下获得可靠长时程预测，以适应多样机器人任务。进一步给出策略优化框架，在想象环境中高效训练并部署到真实系统。工作针对长时程预测、误差累积与仿真到现实迁移，为自适应高效机器人系统提供可扩展路径。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2501.10100"
  },
  {
    "id": "2505.03238",
    "nickname": "RobotxR1",
    ...
    "authors": [
      "Liam Boyle",
      "Nicolas Baumann",
      "Paviththiren Sivasothilingam et al."
    ],
    "year": 2025,
    "published": "2025-01-01",
    "tags": [
    ...
    "abstractZh": "RobotxR1 把 R1-zero 思路扩到机器人：用闭环强化学习让小参数量 LLM 在机载、非持续云连接条件下具备具身智能，平衡能力与算力 / 内存约束。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2505.03238"
  },
  {
    "id": "2503.03911",
    "nickname": "2503.03911",
    ...
    "abstractZh": "LLM 零样本增强人机交互，但其概率性缺形式保证。本文用可达性分析为 LLM 控制的机器人提供形式化安全保证，针对不可预测环境中的安全关键部署。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2503.03911",
    "pdf": "https://arxiv.org/pdf/2503.03911"
  },
  {
    "id": "2503.07885",
    "nickname": "2503.07885",
    ...
    "abstractZh": "讨论 LLM 机器人的安全护栏：覆盖幻觉等平均错误与对抗越狱，指出传统机器人安全不管 LLM 的上下文脆弱性，需要针对语言控制栈的护栏。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2503.07885",
    "pdf": "https://arxiv.org/pdf/2503.07885"
  },
  {
    "id": "2506.01844",
    "nickname": "SmolVLA",
    ...
    "venue": "24 pages. Code and assets: https://github.com/huggingface/lerobot",
    ...
    "abstractZh": "预训练 VLM 蕴含丰富视觉与语言知识，常被改造成 VLA，但现有模型动辄数十亿参数，训练贵、难部署，且多依赖学术工业数据、忽视社区廉价平台数据。SmolVLA 是小型、高效、社区驱动的 VLA，大幅降低训练与推理成本且保持竞争力，可在单 GPU 训练、消费级 GPU 甚至 CPU 部署。异步推理栈将感知与动作预测与执行解耦，以分块动作提高控制频率。紧凑体量下性能可比大约 10 倍的 VLA；并在仿真与真机基准上评估、公开代码与数据。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "SpatialVLA 在 110 万真实回合上训练空间增强 VLA，用自我中心位置编码与自适应空间网格注入 3D 信息。RSS 2025，开源已核验，零样本与新本体适应表现强，推理 token 更少。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "arXiv admin note: This submission has been withdrawn due to serious violation of arXiv policies for acceptable submissio",
    ...
    "abstractZh": "本文是由大语言模型生成的 VLA 综述，概括方法、发现与未来方向，仅作演示，不代表原创研究，意在展示 AI 辅助文献综述的可能。随着 AI 生成内容增多，准确性、可靠性与综合质量仍是挑战。作者计划构建 AI 辅助综述的结构化框架，改进引用准确性、来源可信度与语境理解，并讨论 LLM 用于学术写作的潜力与局限，作为系统化利用 AI 做文献综合的初步探索。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2502.06851",
  ...
  },
  {
    ...
    "abstractZh": "本文提出学习新颖的4D具身世界模型，根据具身智能体动作预测三维场景随时间的动态演化并保持时空一致性。方法是在RGB-DN（RGB、深度与法向）视频上训练：先用现成模型为机器人操作视频补充深度与法向，再微调视频生成模型联合预测每帧RGB-DN，最后将生成结果直接转为高质量4D场景。该方法保证具身预测的时空连贯，支持新视角合成，并促进显著优于先前视频世界模型的策略学习。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2504.20995"
  },
  {
    "id": "2506.19850",
    "nickname": "2506.19850",
    ...
    "abstractZh": "Unified Vision-Language-Action Model 研究统一架构同时做视觉—语言理解与动作生成，减少「理解模型 + 动作头」的割裂。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "Universal Actions 研究跨本体具身基础模型的通用动作表示，使不同机器人共享动作接口，增强通才 VLA 的跨本体迁移。",
    "highlightsZh": [
      "方法：设计跨本体共享的通用动作表示。",
      "贡献：提升具身基础模型的跨机器人迁移。",
  ...
  },
  {
    ...
    "abstractZh": "UniVLA 学习任务中心的潜在动作，使策略可在不同本体与场景「随处行动」，用潜在动作统一跨环境控制。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "本文探索自监督路径：结合互联网规模视频与少量机器人轨迹，构建能理解、预测并规划物理世界的模型。先在逾百万小时网络视频上预训练无动作的联合嵌入预测架构V-JEPA 2，再与大语言模型对齐以提升视频问答。随后用Droid中少于62小时无标注机器人视频后训练潜在动作条件世界模型V-JEPA 2-AC，并在两实验室Franka机械臂上按图像目标零样本完成抓放，无需这些环境的数据或任务特定训练与奖励。",
    "highlightsZh": [
  ...
  {
    "id": "2505.04769",
    "nickname": "Vision-Language-Action (VLA) Models",
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2505.04769",
    "pdf": "https://arxiv.org/pdf/2505.04769"
  },
  {
    "id": "2510.07077",
    "nickname": "Vision-Language-Action Models for Robotics",
    ...
    "abstractZh": "在利用LLM与VLM推进机器人学的背景下，VLA通过规模化统一视觉、语言与动作数据，旨在学习可跨任务、物体、本体与环境泛化的策略，从而以极少或无需任务数据解决新下游任务。本文提供涵盖软硬件的全栈综述，覆盖策略与架构演进、组成模块、模态处理与学习范式，并回顾常用机器人平台、数据采集、公开数据集、数据增强与评测基准，为将VLA部署到真实机器人系统提供实践指引。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2510.07077",
    "pdf": "https://arxiv.org/pdf/2510.07077"
  },
  {
    "id": "2510.11027",
    "nickname": "Vlaser",
    ...
    "abstractZh": "针对上游VLM具身推理与下游VLA策略学习之间的缺口，本文提出Vlaser——具备协同具身推理能力的VLA，作为融合高层推理与低层控制的基础视觉语言模型。基于高质量Vlaser-6M数据集，在空间推理、具身定位、具身问答与任务规划等基准上取得领先。并系统考察不同VLM初始化对监督式VLA微调的影响，以缓解互联网预训练与具身策略数据之间的域偏移；据此在WidowX上达到领先、在Google Robot上具有竞争力。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "针对当前VLA生成大量token导致推理延迟与训练成本高、且生成动作利用不足的问题，本文提出训练框架，以高并行方式微调VLA生成显著更少的动作token。并引入基于投票的集成推理，融合当前与历史动作预测以提升动作利用率。结果显示相对先进VLA有更高成功率，推理较OpenVLA快39倍，边缘平台吞吐46 Hz，具备实际部署性。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "本文提出WorldVLA，将VLA与世界模型统一为自回归动作世界模型：世界模型依动作与图像理解预测未来图像以学习环境物理，动作模型依图像观测生成动作并反哺视觉理解与生成，二者相互增强。针对自回归动作序列误差传播导致性能下降，提出在生成当前动作时选择性掩蔽先前动作的注意力掩码策略，显著改善动作块生成。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "X-VLA 用软提示 Transformer 做可扩展跨本体视觉—语言—动作模型，以提示而非重训适应新本体。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "π₀.₅ 是 Physical Intelligence 的视觉—语言—动作模型，强调开放世界泛化。作为 π₀ 后续，它被层次化 Agent 与 OpenPI 栈广泛当作低层通才策略。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "模仿学习能高效传授灵巧技能，但稳健可泛化通常需大量示范。本文提出3D Diffusion Policy（DP3），将紧凑三维视觉表征纳入扩散策略：由稀疏点云经高效点编码器提取。在72项仿真任务中，多数仅用10条示范即可完成并相对基线提升24.2%；4项真实任务各40条示范成功率达85%，并在空间、视角、外观与实例上表现良好泛化，且较少违反安全约束。评估强调三维表征对真实机器人学习的关键作用。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "3D-VLA 提出三维视觉—语言—动作生成式世界模型，在 3D 场景中把语言、感知与动作交互统一建模。它补全本包 OSS 已收录、论文卡片此前缺失的 WM×VLA 交叉地标。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "机器人与基础模型综述，面向具身人工智能，梳理语言、视觉与动作基础模型如何进入机器人栈，并讨论评测与安全。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2402.02385",
    "pdf": "https://arxiv.org/pdf/2402.02385"
  },
  {
    "id": "2405.14093",
    "nickname": "2405.14093",
    ...
    "abstractZh": "具身AI因控制智能体在物理世界执行任务而被视为AGI基石。在LLM与VLM成功之上，VLA应运而生以生成动作、完成语言条件机器人任务。本文给出面向具身AI的首份VLA综述，将研究分为三条主线：VLA各组成模块、擅长预测低层动作的VLA控制策略，以及把长时程任务分解为子任务序列的高层规划器。并汇总数据集、仿真器与基准，讨论挑战与未来方向。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_api",
    "arxiv": "https://arxiv.org/abs/2405.14093",
    "pdf": "https://arxiv.org/pdf/2405.14093"
  },
  {
    "id": "2401.14403",
    "nickname": "2401.14403",
    ...
    "abstractZh": "实验室内的移动操作常止于抓—移—放。本文提出开放世界移动操作系统，全栈处理真实门、柜、抽屉与冰箱等铰接物：先用少量数据行为克隆，再在分布外物体上在线练习。配套约 2 万美元的低成本移动操作平台。在卡内基梅隆校园 4 栋楼、20 个铰接物上，每物不足 1 小时在线学习即可把成功率从行为克隆的 50% 提高到 95%。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2401.14403",
    "pdf": "https://arxiv.org/pdf/2401.14403"
  },
  {
    "id": "2401.12963",
    "nickname": "AutoRT",
    ...
    "abstractZh": "AutoRT 用 VLM 做场景理解、用 LLM 提出多样指令，并借助「机器人宪法」过滤不安全任务，从而在未见场景以极少人工监督部署机器人车队。系统在 4 栋楼、20 余台机器人上收集 7.7 万真实回合，展示 LLM 控制机器人在真实环境中自主提出目标并采集数据。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2401.12963"
  },
  {
    "id": "2410.12822",
    "nickname": "AVID",
    ...
    "venue": "Project Webpage: https://sites.google.com/view/avid-world-model-adapters/home",
    ...
    "abstractZh": "决策任务中带动作标注的数据稀缺。AVID在无法获取预训练参数的前提下，将预训练视频扩散模型适配为动作条件世界模型：在少量领域动作标注视频上训练适配器，用学习到的掩码修改中间输出以生成准确的动作条件视频。在电子游戏与真实机器人数据上优于现有扩散模型适配基线，表明若使用得当，预训练视频模型可成为具身AI的有力工具。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2410.12822",
    "pdf": "https://arxiv.org/pdf/2410.12822"
  },
  {
    "id": "2409.03299",
    "nickname": "2409.03299",
    ...
    "venue": "14 pages, submitted to the joint Artificial Intelligence & Machine Learning conference for Belgium, Netherlands & Luxemb",
    ...
    "abstractZh": "传统机器人需为每项任务、环境与形态收集专用数据。本研究考察RT-1-X机器人基础模型对训练中未见的UMI-RTX SCARA机器人的泛化。初始实验显示其无法零样本泛化到该未见机型；但经示范微调后，机器人可学会基础模型中已有、却针对另一机型学习的拾取任务。当面对基础模型包含、微调数据未出现的物体时，仅技能迁移，物体特定知识并未迁移。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_api",
    "arxiv": "https://arxiv.org/abs/2409.03299",
    "pdf": "https://arxiv.org/pdf/2409.03299"
  },
  {
    "id": "2411.00508",
    "nickname": "CLIP-RT",
    ...
    "venue": "Accepted to RSS 2025. Project website: https://clip-rt.github.io",
    ...
    "abstractZh": "自然语言可作为易用的机器人学习接口。本文研究非专家用自然语言监督采集数据，并直接据此训练策略。提出采集与增强框架，以及CLIP-RT这一VLA：适配预训练CLIP，用对比模仿学习预测基于语言的运动原语；在Open X-Embodiment上训练并在框架采集的域内数据上微调。真实评估中以约1B参数平均成功率高出OpenVLA 24%；仿真LIBERO平均成功率93.1%，推理吞吐163 Hz。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "Code-as-Monitor（CaM）用 VLM 做开集失败的反应式与预防式检测：以约束感知的视觉编程同时在失败后识别，并在可预见失败前预防，服务闭环机器人。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2412.04455",
    "pdf": "https://arxiv.org/pdf/2412.04455"
  },
  {
    "id": "2411.19650",
    "nickname": "CogACT",
    ...
    "abstractZh": "CogACT 在 OpenVLA 一类骨干上增加扩散动作模块，以协同认知（VLM）与动作生成。它代表「VLM 骨干 + 专门动作头」的 VLA 设计，常被 SpatialVLA 等后续引用。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "既有 LLM 任务规划多针对单机或同构简单任务。COHERENT 面向四旋翼、机器狗与机械臂等异构团队：中央分配器提出分解方案并分配子任务，各执行器选择可行动作并回报自我反思，经提案—执行—反馈—调整（PEFA）循环直至完成。配套 100 个长时程异构任务基准，成功率与执行效率大幅超过先前方法。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2409.15146"
  },
  {
    "id": "2411.09022",
    "nickname": "DART-LLM",
    ...
    "authors": [
      "Yongdong Wang",
      "Runze Xiao",
      "Jun Younes Louhi Kasahara et al."
    ],
    "year": 2024,
    "published": "2024-01-01",
    "tags": [
    ...
    "pdf": "https://arxiv.org/pdf/2411.09022"
  },
  {
    "id": "2405.12399",
    ...
    "abstractZh": "DIAMOND（Diffusion for World Modeling）表明视觉细节对 Atari 世界模型很重要：用扩散模型作世界模型并在想象中训练 RL 智能体。本包 OSS 已收录其仓库，此处补论文卡片。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "GameNGen 表明扩散模型可作实时游戏引擎：在动作条件下交互生成游戏画面，展示交互视频世界模型的实时性。官方可训练栈仍未核验开放，与本包缺口说明一致。",
    "highlightsZh": [
      "方法：动作条件扩散实时生成交互游戏帧。",
  ...
  },
  {
    ...
    "abstractZh": "本文认为世界模型应能在离线轨迹上训练、支持测试时行为优化并做任务无关推理。DINO-WM不重建视觉世界，而是利用DINOv2预训练的空间patch特征，通过预测未来patch特征从离线行为轨迹学习视觉动态，并将目标特征作为预测对象，经动作序列优化达成观测目标。在六个环境上无需专家示范、奖励建模或预训练逆模型即可零样本规划，在任意迷宫、不同形状物体的推操作及多粒子场景上优于先前工作。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "现有驾驶世界模型多依赖视频扩散，擅长视觉生成但难灵活纳入动作等模态。本文把驾驶仿真与轨迹规划统一为序列建模：提出由交错图像与动作token构成的多模态驾驶语言，并以标准下一token预测训练DrivingGPT，联合学习世界建模与规划。该方法在动作条件视频生成与端到端规划上表现突出，并在大规模nuPlan与NAVSIM基准上优于强基线。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "DROID 是大规模野外机器人操作数据集，覆盖多样场景与任务，为通用 VLA 与世界模型微调提供真实轨迹。Ctrl-World 等后续工作即在其上训练。",
    "highlightsZh": [
      "方法：采集大规模野外真实操作轨迹并公开。",
    ...
    "pdf": "https://arxiv.org/pdf/2403.12945"
  },
  {
    "id": "2407.02220",
    "nickname": "Embodied AI in Mobile Robots",
    ...
    "abstractZh": "提出面向移动智能体的 LLM 具身路径规划框架，分层解决高层覆盖路径规划与低层控制：提示 LLM 做覆盖规划，再交给低层执行，用于移动机器人巡检 / 覆盖。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2407.02220"
  },
  {
    "id": "2406.08481",
    "nickname": "2406.08481",
    ...
    "pdf": "https://arxiv.org/pdf/2406.08481"
  },
  {
    "id": "2402.15391",
    "nickname": "Genie",
    ...
    "abstractZh": "本文提出Genie，首个从无标注互联网视频以无监督方式训练的生成式交互环境。可通过文本、合成图、照片甚至草图提示，生成丰富的可动作控制虚拟世界。约11B参数，由时空视频分词器、自回归动力学模型与可扩展的潜在动作模型组成，被视为基础世界模型。即便训练无真实动作标签，用户仍可逐帧在生成环境中行动；学到的潜在动作空间还可让智能体模仿未见视频中的行为。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "GR-2 是带网络规模知识的生成式视频—语言—动作模型，用于机器人操作。相对 GR-1，它扩大视频—语言—动作生成能力，作为闭源 / 实验室通才 VLA 的重要后续。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "Imagination Policy 用生成式点云模型学习操作策略：在想象的三维未来上规划或条件生成动作。它把点云世界预测接到策略，属于 3D World Model 服务操作的一条线。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2406.11740",
    "pdf": "https://arxiv.org/pdf/2406.11740"
  },
  {
    "id": "2406.14540",
    "nickname": "IRASim",
    ...
    "abstractZh": "针对精细机器人—物体交互难以对齐动作与各帧的问题，IRASim依据历史观测与动作轨迹生成细粒度交互视频：在扩散Transformer各块中加入帧级动作条件模块以强化动作—帧对齐。生成质量优于基线并随规模提升；策略评估与真实仿真器高度相关；测试时基于该模型规划可提升策略（Push-T的IoU由0.637至0.961）；并可用键盘或VR控制数据集中的虚拟机械臂。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "研究越狱攻击 LLM 控制的机器人：把对独立 LLM 的越狱扩展到操作、行走与自动驾驶等身体系统，展示恶意提示如何绕过护栏并诱发有害机器人行为。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2410.13691"
  },
  {
    "id": "2404.02018",
    "nickname": "2404.02018",
    ...
    "pdf": "https://arxiv.org/pdf/2404.02018"
  },
  {
    "id": "2410.11758",
    "nickname": "2410.11758",
    ...
    "abstractZh": "LAPA（Latent Action Pretraining from Videos）从无动作标注视频中预训练潜在动作，再迁到机器人 VLA，降低对大规模动作标注的依赖。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2410.11758"
  },
  {
    "id": "2406.20095",
    "nickname": "LLaRA",
    ...
    "abstractZh": "将预训练VLM直接用于机器人控制在示范有限时仍困难。LLaRA把机器人动作策略表述为视觉—文本对话，以便高效把预训练VLM转化为VLA。首先由已有行为克隆数据自动生成对话式指令微调数据，使动作与图像像素坐标对齐；再以自监督定义六项辅助任务增强数据，无需额外动作标注。少量此类数据微调后即可产生有意义的控制决策，并在多项仿真与真实任务上取得领先，同时保留大语言模型的泛化能力。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2406.20095"
  },
  {
    "id": "2406.08824",
    "nickname": "2406.08824",
    ...
    "pdf": "https://arxiv.org/pdf/2406.08824"
  },
  {
    "id": "2404.14285",
    "nickname": "LLM-Personalize",
    ...
    "abstractZh": "LLM-Personalize 用强化自我训练把 LLM 规划器对齐到人的偏好，使家用或个性化任务计划更符合特定用户，而不是通用常识计划。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2404.14285"
  },
  {
    "id": "2403.11552",
    "nickname": "2403.11552",
    ...
    "abstractZh": "LLM3 把大语言模型用于任务与运动规划，并纳入运动失败推理：当运动规划失败时用语言推理调整任务计划，形成 TAMP 闭环。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "MALMM 用多智能体大语言模型做零样本机器人操作：针对单次生成长时程计划的幻觉与不适应，用多角色 Agent 分工规划与修正，提高零样本操作规划。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2411.17636"
  },
  {
    "id": "2401.07314",
    "nickname": "MapGPT",
    ...
    "venue": "LLM/VLM-based VLN Agents. Accepted to ACL 2024. Project: https://chen-judge.github.io/MapGPT/",
    ...
    "abstractZh": "现有零样本VLN智能体仅提示GPT-4在局部环境中选择位置，缺少有效全局视图。MapGPT引入在线语言形式地图以促进全局探索：将含节点信息与拓扑关系的在线地图写入提示，帮助GPT理解空间；并据此提出自适应规划，使智能体基于地图逐步进行多步路径规划、系统探索候选节点或子目标。该方法适用于GPT-4与GPT-4V，在R2R与REVERIE上同时取得领先零样本性能（成功率约分别提升10%与12%）。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "人类示范模仿学习多集中于桌面操作，缺乏通用任务所需的移动性与灵巧性。本文提出低成本全身遥操作系统Mobile ALOHA，为ALOHA增加移动底盘与全身遥操作接口以采集双臂移动操作数据。用监督行为克隆并与已有静态ALOHA数据共同训练可提升移动操作；每任务50条示范时，共训练最高可将成功率提高90%，使系统自主完成炒虾上菜、开双门橱柜存放重锅、呼叫并进入电梯、用水龙头轻冲锅等任务。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "用少量例子学习具身智能体的多模态接地规划与高效重规划：减少对大量自由语言标注的依赖，在步骤细化时结合多模态接地并在失败后高效重规划。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "借助LLM进展，用其做指令跟随的机器人导航受到关注，但接入VLN时智能体表现常明显落后于专用模型，且语言的解释与交流能力未被充分利用。本文在冻结LLM中对齐视觉内容以使其理解观测，并将LLM与导航策略网络结合，以同时做出有效动作预测与语言化导航推理，从而弥合VLN专用模型与基于LLM的导航范式。方法具有数据效率，并缩小了语言模型智能体与先进VLN专用模型之间的差距。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2407.12366"
  },
  {
    "id": "2412.04453",
    "nickname": "NaVILA",
    ...
    "abstractZh": "NaVILA 是腿式机器人的视觉—语言—动作导航模型：高层产生语言导航命令，低层实时运动策略执行。它把 VLA 接到四足 / 腿式导航，RSS 2025，开源已核验。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Project website: https://octo-models.github.io",
    ...
    "abstractZh": "多样化机器人数据上预训练的大策略，有望仅用少量域内数据微调并广泛泛化，但须适配多样传感器、动作空间与平台。本文提出开源通才操作策略 Octo：基于 Transformer，在 Open X-Embodiment 的 80 万条轨迹上训练，可用语言或目标图像指令，并在消费级 GPU 上数小时内微调到新感知与动作空间。跨 9 个平台实验显示其可作为有效初始化，并做了架构与数据消融。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "OK-Robot 问：把开放知识模型（开放词汇检测、语言条件导航与抓取）拼成家用拾取—放置系统，真正重要的是什么。它给出模块化零样本框架，在真实家庭中做语言条件拾放，并分析各模块对成败的贡献。开源仓库已核验。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "分析 LLM / VLM 控制机器人的脆弱性：提示攻击、错误接地与不安全输出如何变成危险身体动作，指出语言控制栈与纯策略 VLA 不同的攻击面。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2402.10340",
    "pdf": "https://arxiv.org/pdf/2402.10340"
  },
  {
    "id": "2406.09246",
    "nickname": "OpenVLA",
    ...
    "venue": "Website: https://openvla.github.io/",
    ...
    "abstractZh": "在互联网视觉-语言数据与多样机器人演示上预训练的策略可微调为稳健 VLA，但既有模型多不开放且缺少高效微调。本文提出 70 亿参数开源 VLA OpenVLA，在 97 万条真实演示上训练，以 Llama 2 结合融合 DINOv2 与 SigLIP 的视觉编码器。其在 29 项任务与多本体上比闭源 RT-2-X 绝对成功率高 16.5%、参数约少 7 倍，微调后亦优于 Diffusion Policy，并可用低秩适配与量化部署。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Website: https://world-model.maitrix.org/",
    ...
    "abstractZh": "World Model 按动作模拟未来状态，支撑交互内容与长程推理。现有 LLM 受限于语言模态，视频模型又缺可交互动作控制。本文提出 Pandora：混合自回归-扩散模型，以生成视频模拟世界状态，并用自由文本动作实时控制。经大规模预训练与指令微调获得跨域性、一致性与可控性；集成预训练 70 亿 LLM 与视频模型，仅需轻量微调，并展示室内外、自然/城市、人/机器人、2D/3D 等多样输出。",
    "highlightsZh": [
  ...
  {
    "id": "2406.10788",
    "nickname": "Physically Embodied Gaussian Splatting",
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2406.10788",
    "pdf": "https://arxiv.org/pdf/2406.10788"
  },
  {
    "id": "2405.01534",
    "nickname": "Plan-Seq-Learn",
    "title": "Plan-Seq-Learn: Language Model Guided RL for Solving Long Horizon Robotics Tasks",
    "authors": [
      "Murtaza Dalal",
      "Tarun Chiruvolu",
      "Devendra Chaplot et al."
    ],
    "year": 2024,
    "published": "2024-01-01",
    "tags": [
    ...
    "abstractZh": "Plan-Seq-Learn 用语言模型引导强化学习求解长时程机器人任务：LLM 提供计划或子目标序列，RL 在子目标上学习，从而结合语言分解与技能学习。",
    "highlightsZh": [
      "方法：语言计划分解 + 序列上的强化学习。",
    ...
    "pdf": "https://arxiv.org/pdf/2405.01534"
  },
  {
    "id": "2410.07864",
    "nickname": "RDT-1B",
    ...
    "abstractZh": "RDT-1B 是面向双臂操作的十亿级扩散基础模型，用扩散动作头学习双臂协调。它补全 OpenVLA / π₀ 之外的双臂扩散 VLA 一线。",
    "highlightsZh": [
      "方法：十亿参数扩散基础模型生成双臂动作。",
    ...
    "pdf": "https://arxiv.org/pdf/2410.07864"
  },
  {
    "id": "2409.01652",
    "nickname": "ReKep",
    ...
    "abstractZh": "ReKep 用关系关键点约束表示操作：约束是把环境中 3D 关键点映射为代价的 Python 函数，再分层优化得到 SE(3) 末端轨迹。VLM 与大视觉模型可从语言与 RGB-D 自动生成 ReKep，从而在移动单臂与双臂平台上无任务数据地完成多阶段、野外与双臂行为。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "RoboCasa 提供面向通才机器人的大规模日常任务仿真，支持语言条件家务操作数据生成与评测，常被 VLA 与层次化 Agent 用作仿真床。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2406.02523"
  },
  {
    "id": "2402.16117",
    "nickname": "RoboCodeX",
    ...
    "abstractZh": "RoboCodeX 做机器人行为合成的多模态代码生成：从视觉与语言生成可执行行为代码，扩展 Code as Policies 到更强的多模态程序合成。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2402.16117",
    "pdf": "https://arxiv.org/pdf/2402.16117"
  },
  {
    "id": "2404.12377",
    ...
    "abstractZh": "文本到视频模型可用于机器人决策中的未来动作想象与环境仿真，但泛化受限，难以合成训练时未见过的物体与动作组合。本文提出 RoboDreamer，通过分解视频生成学习组合式 World Model：将指令解析为低层原语并分别条件生成。该分解使新指令可写成已见成分的组合，并支持语言与目标图像的多模态目标。方法能在 RT-X 上对未见目标合成视频计划，在仿真中成功执行，并优于单体基线。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "Embodied Chain-of-Thought（ECoT）让机器人策略在输出动作前生成接地的推理轨迹，把 VLA 的端到端控制与 Agent 式思维链结合。实验表明具身推理痕迹可提高复杂指令跟随与可解释性。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2407.08693"
  },
  {
    "id": "2409.19471",
    "nickname": "SELP",
    ...
    "abstractZh": "SELP 为机器人智能体生成安全且高效的任务计划。关键是等价投票、约束解码与领域微调，使复杂命令与长时程任务仍遵守用户约束，而不是只追求表面可执行。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Technical Report. Github: https://github.com/showlab/ShowUI",
    ...
    "abstractZh": "构建 GUI 助手可提升效率，但多数智能体依赖闭源 API 与 HTML 等文本元信息，难以如人感知界面视觉。本文提出数字世界 VLA 模型 ShowUI：以 UI 引导视觉 token 选择把截图建模为连通图并剔除冗余；交错视觉-语言-动作流统一导航历史与多轮查询-动作；以及经策展重采样的小规模高质量 GUI 数据。20 亿参数模型用 25.6 万数据达 75.1% 零样本截图接地，并减少 33% 冗余 token、加速 1.4 倍。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2411.17465"
  },
  {
    "id": "2410.03035",
    "nickname": "SPINE",
    ...
    "pdf": "https://arxiv.org/pdf/2410.03035"
  },
  {
    "id": "2409.12514",
    "nickname": "TinyVLA",
    ...
    "abstractZh": "VLA 在视觉运动控制与指令理解上潜力显著，但推理慢且需大量机器人数据预训练。本文提出紧凑 VLA 家族 TinyVLA：推理更快、数据更高效，且无需预训练阶段。以稳健高速多模态模型初始化骨干，微调时接入扩散策略解码器以输出精确动作。仿真与真机评估显示其速度与数据效率显著优于 OpenVLA，性能相当或更好，并在语言、新物体、未见位置、外观、背景与环境变化上泛化强。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "TraceVLA 用视觉轨迹提示增强通才机器人策略的时空意识：在观测上叠加或提示运动痕迹，帮助 VLA 理解「怎么动」。",
    "highlightsZh": [
  ...
  {
    "id": "2412.14803",
    "nickname": "Video Prediction Policy",
    ...
    "abstractZh": "Video Prediction Policy 用预测性视觉表征训练通才机器人策略：先预测未来视频，再据此生成动作，把视频世界预测接到 VLA 式控制。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Authors contributed equally to this work, and supervisors contributed equal advising to this work; GitHub repository: ht",
    ...
    "abstractZh": "视觉-语言导航（VLN）近年受到关注，方法不断涌现；基础模型的成就也重塑了该领域的挑战与路径。本综述提供自上而下的评述，采用具身规划与推理的原则性框架，并强调利用基础模型应对 VLN 挑战的现有方法与未来机遇。作者希望一方面里程碑式梳理进展、探讨基础模型的潜在角色，另一方面把 VLN 中的不同挑战与解决方案组织给基础模型研究者参考。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_api",
    "arxiv": "https://arxiv.org/abs/2407.07035",
    "pdf": "https://arxiv.org/pdf/2407.07035"
  },
  {
    "id": "2412.14058",
    "nickname": "2412.14058",
    ...
    "abstractZh": "如何把动作注入基础 VLM 以构建 VLA，关键因素仍不清。本文回答三问：选何种骨干、如何组织 VLA 架构、何时加入跨本体数据。据此提出少手工设计的 RoboVLMs 家族，在三个仿真任务与真机上达新 SOTA。实验覆盖 8 个以上 VLM 骨干、4 种策略架构与 600 余组设计，并开源灵活框架与配方。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "Wonderful Team 是多智能体视觉大模型框架，做零样本高层物理任务规划：给定新环境图像与任务描述，输出完成任务所需动作序列，而无需该环境的先验训练。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2407.19094"
  },
  {
    "id": "2409.16784",
    "nickname": "2409.16784",
    ...
    "abstractZh": "腿式多样地形运动需要本体感觉与视觉的精确感知，但直接从高维视觉学习往往数据低效。教师-学生模仿因信息差距难以最优。本文提出基于 World Model 的感知（WMP）：先建环境模型再学策略。尽管完全在仿真中训练，该模型仍能准确预测真实轨迹。仿真与真机实验表明其在可通过性与鲁棒性上优于现有基线。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2409.16784"
  },
  {
    "id": "2401.09985",
    "nickname": "WorldDreamer",
    ...
    "venue": "project page: https://world-dreamer.github.io/",
    ...
    "abstractZh": "World Model 对预测世界动力学、生成视频至关重要，但现有模型多限于游戏或驾驶。本文提出 WorldDreamer，将世界建模视为无监督视觉序列建模：把视觉映射为离散 token 并预测被掩码者，同时引入多模态提示。实验表明其能在自然场景与驾驶等情境生成视频，并胜任文本到视频、图像到视频与视频编辑。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2401.09985"
  },
  {
    "id": "2410.17491",
    "nickname": "X-MOBILITY",
    ...
    "abstractZh": "挑战环境下的通用导航仍困难：经典方法需大量调参，学习方法又难泛化到分布外。本文提出端到端可泛化导航模型 X-Mobility：用带潜空间的自回归 World Model 刻画动力学；多样多头解码器学习与导航相关的丰富状态；并将世界建模与动作策略解耦，从而融合离/在策略数据。实验表明其超越现有导航方法，并具备零样本 Sim2Real 与跨本体潜力。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "See project website for videos: https://physicalintelligence.company/blog/pi0 Published in RSS 2025",
    ...
    "abstractZh": "本文讨论通才机器人策略（机器人基础模型）如何应对数据、泛化与鲁棒性障碍，并提出基于预训练VLM的流匹配架构以继承互联网规模语义知识。该模型在单臂、双臂与移动操作等多类灵巧机器人平台的大规模多样数据上训练，评估其预训练后的零样本任务能力、对人及高层VLM策略语言指令的跟随，以及经微调获取新技能的能力，任务涵盖叠衣服、清理桌面与组装纸箱等。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "多数 LLM 智能体要么贪心无规划，要么静态计划不适应反馈，随问题变复杂而退化。AdaPlanner 根据环境反馈自适应改写计划，使顺序决策在更长时程上保持可修正。",
    "highlightsZh": [
      "方法：由环境反馈自适应改写语言模型计划。",
      "贡献：缓解静态计划在长时程上的退化。",
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2305.16653",
  ...
  },
  {
    ...
    "abstractZh": "现有通用模型多依赖二维图像，对三维输入与三维世界中定义的任务（接地、具身推理与行动）能力有限。LEO 是面向三维世界的具身多模态通才智能体，统一任务接口、架构与目标，分两阶段训练：三维视觉—语言对齐，再做三维视觉—语言—动作（VLA）指令微调。作者收集物体级与场景级大规模数据，并用 LLM 辅助管线生成高质量三维视觉—语言数据。实验覆盖三维描述、问答、具身推理、导航与操作；消融与缩放分析为后续具身通才提供参照。代码与数据见项目页。",
    "highlightsZh": [
  ...
  {
    "id": "2312.10807",
    "nickname": "Bridging Language and Action",
    ...
    "abstractZh": "语言条件机器人操作旨在让机器人理解并执行自然语言指令，以实现人机沟通与协作；该交叉领域融合场景理解、语言处理与策略学习。本综述系统梳理近期进展，按语言接入方式分类：语言用于状态评估、作为策略条件、用于认知规划与推理，以及统一视觉-语言-动作模型。进一步从动作粒度、数据与监督、系统成本与延迟、环境与评测、任务规格五轴分析现有技术，并归纳关键争论。最后讨论开放挑战与未来方向，聚焦提升泛化与应对安全问题。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "CoELA 针对分散控制、原始感知、有代价通信与多目标任务，把 LLM 嵌入感知、记忆、通信、规划与执行五个模块。在 C-WAH 与 TDW-MAT 上，GPT-4 驱动的 CoELA 超过强规划基线并出现有效通信；对 LLaMA-2 微调的 CoLLAMA 也取得可行表现，人机协作中自然语言通信更获信任。",
    "highlightsZh": [
  ...
  {
    "id": "2303.08268",
    "nickname": "Chat with the Environment",
    ...
    "abstractZh": "少样本 LLM 规划强，但把多模态感知与连续动作接地仍难。本文让机器人与环境「对话」：用交互式多模态感知把传感结果写成语言，再交给 LLM 推理，从而在复杂世界中闭环交互。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2303.08268",
    "pdf": "https://arxiv.org/pdf/2303.08268"
  },
  {
    "id": "2304.03893",
    "nickname": "2304.03893",
    ...
    "abstractZh": "案例研究展示少样本 ChatGPT 把自然语言转为可执行机器人动作序列，并给出易定制、易接入执行系统、可迁移多环境的提示设计，同时尽量降低 ChatGPT 幻觉对控制的影响。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2304.03893",
    "pdf": "https://arxiv.org/pdf/2304.03893"
  },
  {
    "id": "2306.17582",
    "nickname": "ChatGPT for Robotics",
    ...
    "abstractZh": "ChatGPT for Robotics 总结用对话式 LLM 设计机器人应用的原则：提示中暴露高层 API、用语言做任务分解与代码生成，并在多种机器人平台上演示。论文讨论模型能力、安全与人机协作，是工业界早期「对话 Agent 控制机器人」的系统设计报告。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "CLIN 是持续学习的语言智能体，强调快速任务适应与泛化：在新任务上用语言记忆积累经验，而不必每次从零提示，从而加速适应。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2310.10134",
    "pdf": "https://arxiv.org/pdf/2310.10134"
  },
  {
    "id": "2302.00763",
    "nickname": "2302.00763",
    ...
    "abstractZh": "复杂模糊环境中的推理是强化学习难点：强 RL 智能体数据饥渴且难泛化，而大规模语言模型推理与适应强。本文研究与语言模型协作做具身推理，把 LLM 常识接到交互环境中的决策。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2302.00763",
    "pdf": "https://arxiv.org/pdf/2302.00763"
  },
  {
    "id": "2310.07263",
    "nickname": "CoPAL",
    ...
    "abstractZh": "CoPAL 用大语言模型做机器人动作的纠正规划：在执行偏差或失败后重新生成修正计划，强调纠正而非一次性开环计划。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2310.07263",
  ...
  },
  {
    ...
    "abstractZh": "无监督 World Model 可教智能体理解世界，但自动驾驶上规模化慢于 GPT。瓶颈是复杂非结构化观测与可扩展生成模型。本文提出 Copilot4D：VQVAE 离散化观测后以离散扩散预测未来，并把 Masked Generative Image Transformer 改写为可并行去噪。点云上 NuScenes、KITTI Odometry 与 Argoverse2 的 1s Chamfer 距离降逾 65%、3s 降逾 50%。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "Creative Agents 研究开放式创造任务：用想象器把抽象语言变成具体目标（文本或扩散视觉想象），再由行为克隆或代码基础模型执行。在 Minecraft 生存模式中，智能体可按自由语言建造多样建筑，并用 GPT-4V 评估开放创造。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2312.02519"
  },
  {
    "id": "2302.01560",
    "nickname": "Describe, Explain, Plan and Select",
    ...
    "abstractZh": "开放世界多任务规划面临长时程推理与计划不可执行的难题。DEPS（Describe, Explain, Plan and Select）用交互式规划：描述当前处境、解释失败、生成计划并选择可执行技能。在 Minecraft 中，该方法显著提高长时程任务完成率，成为 Voyager 之前的开放世界规划 Agent 代表。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "本文提出 Diffusion Policy，将机器人视觉运动策略表示为条件去噪扩散过程。在 4 个基准的 12 项任务上平均优于现有方法 46.9%。它学习动作分布分数函数梯度，推理时经随机 Langevin 动力学逐步优化，能处理多模态与高维动作并训练稳定。为用于真机，还引入滚动时域控制、视觉条件与时间序列扩散 Transformer。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "DoReMi 通过检测并恢复计划—执行错位来接地语言模型：当执行偏离计划时触发恢复，而不是继续开环执行错误计划，从而提高语言计划在机器人上的可靠性。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2307.00329"
  },
  {
    "id": "2309.09777",
    "nickname": "DriveDreamer",
    ...
    "abstractZh": "World Model 在自动驾驶中因能理解环境而受关注，但既有研究多聚焦游戏或仿真。本文提出完全源于真实驾驶的 DriveDreamer：用扩散模型构建复杂环境表示，并两阶段训练——先理解结构化交通约束，再预测未来状态。这是首个基于真实驾驶场景的 World Model。在 nuScenes 上验证其能精确可控地生成忠实于交通结构的视频，并生成现实合理的驾驶策略。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "EmbodiedGPT 是面向具身人工智能的端到端多模态基础模型，用具身思维链做视觉—语言预训练，使智能体具备多模态理解与规划执行能力。模型在具身规划、视觉问答与操作相关基准上提升，展示把 VLM 预训练接到动作序列的路径。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2305.15021"
  },
  {
    "id": "2310.12931",
    "nickname": "Eureka",
    ...
    "abstractZh": "Eureka 用编码 LLM 做人类水平的奖励设计：在仿真中进化可执行奖励函数，覆盖 29 个机器人任务，并达到与人类奖励相当或更好的表现。它把「写奖励代码」作为 Agent 技能，用于训练低层控制器，开源代码已核验。",
    "highlightsZh": [
  ...
  {
    "id": "2312.07843",
    "nickname": "Foundation Models in Robotics",
    ...
    "abstractZh": "综述机器人中的基础模型：应用、挑战与未来，覆盖语言、视觉与控制接口，为 Agent / VLA / VLM 交叉提供早期全景。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2312.07843",
    "pdf": "https://arxiv.org/pdf/2312.07843"
  },
  {
    "id": "2309.17080",
    "nickname": "GAIA-1",
    ...
    "abstractZh": "GAIA-1 是面向自动驾驶的生成式世界模型，用视频、文本与动作预测未来驾驶场景。它展示基础模型尺度的驾驶世界模拟，但官方代码与权重未开放，是本包诚实标注的闭源 World Model 地标。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2309.17080"
  },
  {
    "id": "2305.17144",
    "nickname": "Ghost in the Minecraft",
    ...
    "abstractZh": "Ghost in the Minecraft（GITM）针对开放世界一般能力，而非单一「获得钻石」。它用 LLM 做层次化规划与结构化文本接口，把 Minecraft 交互表示为可推理的文本世界，从而在广泛任务上取得一般能力。相对目标单一的智能体，GITM 更强调开放任务覆盖与规划—执行分解。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2303.00855",
  ...
  },
  {
    ...
    "abstractZh": "LLM 对世界物理的抽象知识可用于决策，但与环境对齐不足会限制功能能力。GLAM 通过在线强化学习做功能接地，使智能体在交互中对齐语言模型知识与环境，提升可执行能力。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2302.02662",
    "pdf": "https://arxiv.org/pdf/2302.02662"
  },
  {
    "id": "2303.17580",
    "nickname": "HuggingGPT",
    ...
    "abstractZh": "HuggingGPT 用 ChatGPT 作控制器，调度 Hugging Face 上的专家模型完成跨域跨模态任务：LLM 负责任务规划、模型选择、参数生成与结果汇总。该工作展示工具使用 Agent 如何把语言计划接到可调用技能库，为机器人 tool-use 提供非具身对照。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "",
    "abstract": "Foundation models have made significant strides in various applications, including text-to-image generation, panoptic segmentation, and natural language processing. This paper presents Instruct2Act, a framework that utilizes Large Language Models to map multi-modal instructions to sequential actions for robotic manipulation tasks. Specifically, Instruct2Act employs the LLM model to generate Python programs that constitute a comprehensive perception, planning, and action loop for robotic tasks. In the perception section, pre-defined APIs are used to access multiple foundation models where the Segment Anything Model (SAM) accurately locates candidate objects, and CLIP classifies them. In this way, the framework leverages the expertise of foundation models and robotic abilities to convert complex high-level instructions into precise policy codes. Our approach is adjustable and flexible in accommodating various instruction modalities and input types and catering to specific task demands. We validated the practicality and efficiency of our approach by assessing it on robotic tasks in different scenarios within tabletop manipulation domains. Furthermore, our zero-shot method outperformed many state-of-the-art learning-based policies in several tasks. The code for our proposed approach is available at this https URL, serving as a robust benchmark for high-level robotic instruction tasks with assorted modality inputs.",
    "abstractZh": "Instruct2Act 用 LLM 把多模态指令映射为机器人顺序动作：生成调用 SAM、CLIP 等感知工具与操作原语的 Python 程序。框架保留专家技能接口，同时利用 LLM 的零样本多模态推理，在表格操作等任务上实现灵活的指令跟随。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2305.11176",
  ...
  },
  {
    ...
    "abstractZh": "JARVIS-1 是开放世界多任务 Minecraft 智能体：多模态语言模型把视觉与指令映射为计划，再交给目标条件控制器，并用多模态记忆结合预训练知识与生存经验。它可完成 200 余项任务，短时程近乎完美；在获得钻石镐上可靠性约为先前 SOTA 的 5 倍。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2311.05997",
    "pdf": "https://arxiv.org/pdf/2311.05997"
  },
  {
    "id": "2306.08647",
    "nickname": "2306.08647",
    ...
    "abstractZh": "Language to Rewards 让用户用自然语言描述想要的机器人技能，LLM 生成奖励代码，再在仿真中用强化学习优化低层控制器。该「语言→奖励程序→RL」回路可合成新的运动技能，展示代码生成 Agent 对控制器训练的间接控制。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2306.08647"
  },
  {
    "id": "2305.14078",
    "nickname": "2305.14078",
    ...
    "abstractZh": "大规模任务规划极难。本文表明 LLM 既可当策略，也可提供常识世界模型，二者可在蒙特卡洛树搜索中结合以扩展规划规模。相对直接把 LLM 当策略，搜索式组合更能放大常识。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2305.14078"
  },
  {
    "id": "2310.17722",
    "nickname": "2310.17722",
    ...
    "abstractZh": "本文将大语言模型作为具身任务的可泛化策略：不只生成文本计划，而把 LLM 直接或经适配当作跨任务的决策策略，探索语言先验在具身策略中的迁移。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2310.17722",
    "pdf": "https://arxiv.org/pdf/2310.17722"
  },
  {
    "id": "2311.07226",
    "nickname": "Large Language Models for Robotics",
    ...
    "abstractZh": "人类借多模态反馈学习并控制复杂操作的能力可称为灵巧智能。随着 LLM 迅速发展，其在机器人中的应用日益受关注。本综述总结 LLM 对机器人控制、感知、决策与规划的影响；回顾背景、收益与近期模型，梳理感知、决策、控制、交互及跨模块协调技术，并指出近期挑战。作者认为基于 LLM 的机器人是通往具身智能最有前景亦最具挑战的路径之一。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "生成模型已变革文本、图像与视频创作；下一里程碑或是按人类与机器人动作模拟真实体验。本文探索通过生成建模学习通用真实交互模拟器 UniSim：编排在物体、动作密度与运动多样性上各有所长的自然数据，即可由静态场景模拟高层指令与低层控制的视觉结果。用其训练的高层视觉-语言策略与低层强化学习策略，均可纯仿真训练后零样本部署到现实。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2310.06114"
  },
  {
    "id": "2309.15821",
    "nickname": "LGMCTS",
    ...
    "abstractZh": "LGMCTS 用语言引导蒙特卡洛树搜索，做可执行的语义物体重排：在搜索中纳入语言语义，使重排计划既可执行又符合指令语义。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2309.15821",
    "pdf": "https://arxiv.org/pdf/2309.15821"
  },
  {
    "id": "2306.03310",
    "nickname": "LIBERO",
    ...
    "pdf": "https://arxiv.org/pdf/2306.03310"
  },
  {
    "id": "2304.09349",
    "nickname": "LLM as A Robotic Brain",
    ...
    "abstractZh": "具身系统的记忆与控制通常分框架建模。LLM-Brain 用大语言模型统一自我中心记忆与控制，作为可泛化的机器人「大脑」，在交互中同时保持情景记忆并输出控制决策。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2304.09349",
    "pdf": "https://arxiv.org/pdf/2304.09349"
  },
  {
    "id": "2304.11477",
    "nickname": "LLM+P",
    ...
    "abstractZh": "LLM 零样本问答强，但长时程规划不可靠；经典规划器在问题形式化后很强。LLM+P 让 LLM 把语言指令译为 PDDL，再调用最优规划器求解，最后把计划译回自然语言。该方法在规划基准上显著优于仅用 LLM 的计划，为机器人符号规划 Agent 提供可组合接口。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2304.11477"
  },
  {
    "id": "2305.19352",
    "nickname": "LLM-BRAIn",
    ...
    "abstractZh": "LLM-BRAIn 从 Alpaca 7B 微调，把操作员文本命令转为机器人行为树。训练使用约 8500 条指令跟随示范，实现由语言快速生成可执行 BT，便于接入传统机器人执行栈。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2305.19352",
  ...
  },
  {
    ...
    "abstractZh": "LLM-State 为开放世界长时程规划维护语言模型可读的状态表示，使规划器在开放世界中跟踪物体与关系，而不是只依赖对话历史。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2311.17406",
    "pdf": "https://arxiv.org/pdf/2311.17406"
  },
  {
    "id": "2311.17842",
    "nickname": "Look Before You Leap",
    ...
    "abstractZh": "Look Before You Leap 展示 GPT-4V 在机器人视觉—语言规划中的能力：先看再跳，用多模态模型在行动前做视觉推理与计划，减少盲目执行。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2311.17842",
    "pdf": "https://arxiv.org/pdf/2311.17842"
  },
  {
    "id": "2308.10141",
    "nickname": "March in Chat",
    ...
    "abstractZh": "March in Chat 研究远程具身指代表达（REVERIE 一类）：用交互式提示让 LLM 在对话中逐步明确导航与指代目标。方法把语言交互接到具身导航，展示对话 Agent 如何服务 VLN 式远程指令。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2308.10141",
    "pdf": "https://arxiv.org/pdf/2308.10141"
  },
  {
    "id": "2301.04104",
    "nickname": "2301.04104",
    ...
    "abstractZh": "研发能在广泛任务上求解的通用算法是人工智能的基本挑战。现有强化学习迁到新域需大量调参。本文提出 DreamerV3：以单一配置在逾 150 项任务上优于专用方法。它学习环境模型并通过想象未来改进行为，以归一化、平衡与变换保证跨域稳定。开箱即用时，它是首个无人类数据或课程即从零在 Minecraft 中采集钻石的算法。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "大规模 LLM 如 ChatGPT 与 GPT-4 涌现显著推理能力。本文提出纯 LLM 指令跟随导航智能体 NavGPT，对 VLN 做零样本序列动作预测。每步输入观测文本、导航历史与可探索方向以推理并决策。实验表明其能分解子目标、整合常识、识别地标、跟踪进度并调整计划，还能生成导航指令与俯视轨迹。零样本 R2R 仍不及训练模型；作者建议为 LLM 适配多模态输入，并把显式推理用于学习型模型。",
    "highlightsZh": [
  ...
  {
    "id": "2310.10103",
    "nickname": "Navigation with Large Language Models",
    ...
    "venue": "Videos, code, and an interactive Colab notebook that runs in your browser https://sites.google.com/view/lfg-nav/",
    ...
    "abstractZh": "陌生环境导航对机器人很难：建图规划往往需要漫长探索。人类可借助语义迅速导航，但直接用未接地的语言模型指挥可能任意错误。本文提出 Language Frontier Guide（LFG），把语言模型的“语义猜测”作为拓扑或度量地图规划的搜索启发式，以偏置新颖真实环境中的探索。在真实环境与仿真基准上评估，优于无信息探索及其他使用语言模型的方式。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2310.10103",
    "pdf": "https://arxiv.org/pdf/2310.10103"
  },
  {
    "id": "2311.16038",
    "nickname": "OccWorld",
    ...
    "abstractZh": "理解三维场景演化对自动驾驶决策至关重要，但预测物体框难以刻画细粒度信息。本文提出在三维占据空间学习 World Model 的 OccWorld，同时预测自车运动与周围场景演化。三维占据更精细、更易获取，且可适配视觉与 LiDAR。先学重建式场景分词器得到离散 token，再用类 GPT 的时空生成 Transformer 解码未来占据与自车轨迹。在 nuScenes 上能有效建模场景演化，且无实例与地图监督时规划仍有竞争力。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2311.16038"
  },
  {
    "id": "2310.08588",
    "nickname": "Octopus",
    ...
    "abstractZh": "Octopus 是具身视觉—语言程序员：根据环境反馈生成程序，把视觉观察与语言指令编译为可执行代码，并在反馈下改写，属于代码即策略的视觉闭环版本。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Project website: https://robotics-transformer-x.github.io",
    ...
    "abstractZh": "在多样化数据上训练的高容量模型已在 NLP 与视觉中成为统一预训练骨干。机器人学习能否同样整合？传统方法为每个应用、机器人甚至环境单独训练。本文提供标准化格式的数据集与模型以探索通才跨机器人策略。通过 21 家机构协作，汇集 22 种机器人数据，涵盖 527 项技能（160266 个任务）。高容量模型 RT-X 表现出正向迁移，能借助其他平台经验提升多机器人能力。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "提出具身语言模型，将真实世界连续传感模态直接纳入语言模型，以建立词语与感知之间的联系。输入为交织视觉、连续状态估计与文本编码的多模态句子，并与预训练大语言模型端到端训练，用于序列机器人操作规划、视觉问答与描述。评估显示单一大型具身多模态模型 PaLM-E 可处理多种观测模态与多种本体上的具身推理，并在互联网规模语言、视觉与视觉—语言联合训练中呈现正向迁移；最大的 PaLM-E-562B 还是视觉—语言通才，在 OK-VQA 上达先进水平并随规模保留通用语言能力。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2303.03378"
  },
  {
    "id": "2309.09969",
    "nickname": "2309.09969",
    ...
    "abstractZh": "本文研究用大语言模型提示机器人行走：把语言接到步态 / 运动控制接口，展示 LLM 不仅能做操作规划，也能参与运动控制层面的指令跟随。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2309.09969",
    "pdf": "https://arxiv.org/pdf/2309.09969"
  },
  {
    "id": "2309.10150",
    "nickname": "Q-Transformer",
    ...
    "abstractZh": "提出可扩展的强化学习方法，从大型离线数据集训练多任务策略，并可同时利用人类演示与自主采集数据。该方法用 Transformer 作为经离线时序差分备份训练的 Q 函数的可扩展表示，故称 Q-Transformer。通过离散化各动作维度、将每一维 Q 值表示为独立 token，从而把高容量序列建模用于 Q 学习。若干设计决策使离线强化学习表现良好；在大规模多样的真实机器人操作任务集上，Q-Transformer 优于先前离线强化学习算法与模仿学习方法。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "自动检测并分析失败对可解释稳健机器人至关重要。REFLECT 查询 LLM，把机器人经验总结为失败解释并生成纠正，从而用语言反思闭环改进后续执行。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2306.15724"
  },
  {
    "id": "2303.11366",
    "nickname": "Reflexion",
    ...
    "abstractZh": "语言智能体难以像传统强化学习那样从试错中快速学习。Reflexion 用语言形式的强化：智能体把环境反馈转成语言反思并写入情景记忆，供后续试验使用，而无需更新模型权重。在决策、编程与推理任务上显著提升，成为机器人自我纠错 Agent 的常用组件。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "提出多本体、多任务的机器人操作通才智能体 RoboCat：它是视觉目标条件的 decision transformer，可消费带动作标注的视觉经验，覆盖仿真与真实机械臂上多种观测与动作的运动控制技能。可零样本泛化到新任务与新机器人，也可仅用目标任务的 100–1000 条样本进行适配；训练好的模型还能生成数据供后续训练迭代，构成自主改进循环的基本构件。在仿真与三种真实本体上的大规模评估表明，随着训练数据增长与多样化，RoboCat 出现跨任务迁移迹象，并对新任务的适配更为高效。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "RoboGen 是生成式机器人智能体：自动提出任务、生成仿真场景与训练监督，再选择强化学习、运动规划或轨迹优化来学技能。提出—生成—学习循环可反复查询，产生无限多样的技能演示，覆盖刚体、软体与腿式运动。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "RoboGPT 做日常指令的具身长期决策智能体：把家居式长时程指令分解为可执行决策序列，强调日常任务上的长期决策而非单步技能。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2311.15649",
    "pdf": "https://arxiv.org/pdf/2311.15649"
  },
  {
    "id": "2307.04738",
    "nickname": "RoCo",
    ...
    "abstractZh": "RoCo 让多机器人用 LLM 对话协商高层策略，再生成子任务与任务空间航点，交给多臂运动规划器。环境碰撞等反馈被写回提示以改进计划。配套 RoCoBench 覆盖六类协作场景；仿真成功率高，真机还可接入人机对话协作。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Website: https://robotics-transformer.github.io/",
    ...
    "abstractZh": "研究如何将互联网规模数据上训练的视觉—语言模型直接纳入端到端机器人控制，以提升泛化并带来涌现的语义推理。将先进视觉—语言模型在机器人轨迹与互联网规模视觉—语言任务上共同微调；为统一格式，把动作表示为文本 token 并像自然语言 token 一样纳入训练集。此类模型称为视觉—语言—动作模型（VLA），其实例为 RT-2。广泛评估表明可得到有效机器人策略，并使 RT-2 获得对新物体更好泛化、理解机器人数据中未见指令以及初步推理等涌现能力；结合思维链还可进行多阶段语义推理。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "RT-Trajectory 用事后轨迹草图作为任务泛化的条件：把期望的末端轨迹画成或生成为草图，再训练策略跟随。相对纯语言条件，轨迹草图提供更密的时空指导，提高对新任务与新物体的泛化。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "SayCanPay 在 SayCan 上加入可学习领域知识的启发式支付 / 评分，用 LLM 提议技能，用可学习启发式评估长期代价或价值，从而改进启发式规划。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2308.12682",
    "pdf": "https://arxiv.org/pdf/2308.12682"
  },
  {
    "id": "2307.06135",
    "nickname": "SayPlan",
    ...
    "abstractZh": "针对在广阔的多楼层、多房间环境中落地规划这一机器人难题，提出 SayPlan：利用三维场景图（3DSG）表示，实现可扩展的基于大语言模型的大规模任务规划。为保证可扩展性，利用 3DSG 的层次性让 LLM 从压缩小图中对任务相关子图做语义搜索，结合经典路径规划以缩短规划视界，并引入迭代重规划流水线，用场景图仿真器反馈修正不可行动作。在最多三层、三十六房间、一百四十项资产与物体的两大环境上评估，表明可将抽象自然语言指令落地为移动操作机器人可执行的大规模长时程任务计划。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2307.06135"
  },
  {
    "id": "2301.08243",
    "nickname": "2301.08243",
    ...
    "abstractZh": "展示一种不依赖手工数据增强即可学习高语义图像表示的方法。提出基于图像的联合嵌入预测架构 I-JEPA，这是一种从图像做自监督学习的非生成式方法：由单一上下文块预测同一图像中多个目标块的表示。引导其产生语义表示的核心设计是掩码策略——需采样足够大尺度的目标块，并使用足够信息、空间分布充分的上下文块。经验上，与 Vision Transformer 结合时 I-JEPA 具有高可扩展性：例如在 ImageNet 上训练 ViT-Huge/14，可在线性分类、物体计数与深度预测等广泛下游任务上取得较强表现。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2309.10062",
    "pdf": "https://arxiv.org/pdf/2309.10062"
  },
  {
    "id": "2306.17840",
    "nickname": "Statler",
    ...
    "abstractZh": "Statler 让 LLM 维护对不可观测世界状态的估计，并在动作后更新该状态，再据此条件生成下一步。相对 Code as Policies 等仅依赖对话历史的方法，显式状态读写显著提高若干机器人规划任务的成功，并更利于长时程扩展。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2306.17840",
    "pdf": "https://arxiv.org/pdf/2306.17840"
  },
  {
    "id": "2306.00937",
    "nickname": "STEVE-1",
    ...
    "abstractZh": "STEVE-1 把 VPT 行为基础模型按 unCLIP 思路做指令微调：先在 MineCLIP 潜空间对齐指令，再训练文本先验，从而用自监督行为克隆与事后重标注降低文本标注成本（约 60 美元算力）。它用原始像素与键鼠低层控制跟随短时程开放指令，在早期游戏评测中稳健完成 13 项中的 12 项。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "STORM 用随机 Transformer 世界模型做样本高效强化学习：在潜空间对随机动力学建模，并在想象中训练策略。作为 Transformer World Model 一线（与 IRIS / TWM 并列），它补全本包此前仅有仓库、缺少论文卡片的缺口。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "服务机器人多物体重排需要常识，但 LLM 并不天然编码合理物理布局。本文把 LLM 接到任务与运动规划，使物体重排既符合常识又满足几何可行，用于桌面 / 服务操作。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2303.06247",
    "pdf": "https://arxiv.org/pdf/2303.06247"
  },
  {
    "id": "2303.12153",
    "nickname": "Text2Motion",
    "title": "Text2Motion: From Natural Language Instructions to Feasible Plans",
    "authors": [
      "Kevin Lin",
      "Christopher Agia",
      "Toki Migimatsu et al."
    ],
    "year": 2023,
    "published": "2023-01-01",
    "tags": [
    ...
    "abstractZh": "Text2Motion 把自然语言指令转为几何可行的任务—运动计划。框架用少样本 LLM 构造符号目标与技能序列，再用运动规划验证几何可行性；不可行则反馈重规划。相对纯 LLM 计划，它能完成需要长时程几何推理的顺序操作，并在仿真操作任务上提高成功。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2303.12153"
  },
  {
    "id": "2305.05658",
    "nickname": "TidyBot",
    ...
    "abstractZh": "家居整理需要把用户偏好泛化到新场景。TidyBot 用 LLM 从少量示例中总结「东西放哪」的偏好，再结合预训练感知与抓放技能在真实房间整理。系统可个性化放置规则，并在真实家庭环境中完成拾取—放置，展示语言 Agent 对真机家务的控制。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "面向通用机器人的基础模型综述与元分析，比较不同基础模型路线通向通才机器人的证据与缺口，补充 VLA / Agent 设计选择。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2312.08782",
    "pdf": "https://arxiv.org/pdf/2312.08782"
  },
  {
    "id": "2312.02010",
    "nickname": "2312.02010",
    ...
    "abstractZh": "先前具身导航工作多针对特定任务智能体，对未见场景泛化不足。提出首个具身导航通才模型 NaviLLM：通过引入基于 schema 的指令将大语言模型适配到具身导航，把多种任务灵活转为生成问题从而统一任务，并融合多数据集训练以具备具身导航所需的广泛能力。实验表明该统一模型在 CVDN、SOON 与 ScanQA 上达到先进水平，其中 CVDN 的目标进度较先前先进方法显著高出 29%；对未见任务如具身问答与三维描述也表现出强泛化。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2312.02010",
    "pdf": "https://arxiv.org/pdf/2312.02010"
  },
  {
    "id": "2303.07109",
    "nickname": "2303.07109",
    ...
    "abstractZh": "深度网络在强化学习中常过于依赖数据。为构建样本高效的 World Model，以自回归方式将 Transformer 用于真实回合：不仅将紧凑隐状态与已采取动作，也将经历或预测的奖励输入 Transformer，使其可灵活关注三种模态的不同时间步。该 Transformer 可直接访问先前状态，而非经由压缩循环状态观察它们；采用 Transformer-XL 架构以在保持计算效率的同时学习长期依赖。基于 Transformer 的 World Model（TWM）生成有意义的新经验以训练策略，在 Atari 100k 基准上优于先前无模型与基于模型的强化学习算法。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "LLM 在 NLP 上强，但准确推理与求解规划问题仍弱。本文研究如何把自然语言译为规划目标，使经典规划器可用，从而服务机器人任务。结论强调翻译目标比让 LLM 直接当规划器更可靠。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2302.05128",
    "pdf": "https://arxiv.org/pdf/2302.05128"
  },
  {
    "id": "2312.13139",
    "nickname": "2312.13139",
    ...
    "abstractZh": "该文（GR-1）把大规模视频生成预训练用于视觉机器人操作：模型同时预测未来图像与动作，将互联网视频知识迁到操作策略。作为视频—语言—动作生成式通才的早期代表，它衔接后续 GR-2。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Accepted for oral presentation at CoRL 2023",
    ...
    "abstractZh": "提出视觉导航 Transformer（ViNT），旨在将通才预训练模型的成功带到基于视觉的机器人导航。以可适用于任意导航数据集的通用到达目标进行训练，并用灵活的 Transformer 架构学习导航可供性，以高效适配多种下游导航任务。在涵盖数百小时、多种机器人平台的现有导航数据集上训练，呈现正向迁移并优于在单一数据集上训练的专家模型。可用基于扩散的子目标提案探索新环境，并在配备远程启发式时求解公里级导航；亦可用类似 prompt-tuning 的技术，将目标编码器替换为嵌入同一目标 token 空间的其他任务模态（如 GPS 航点或路由指令）。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "寻求以简单微调机器人数据的方式利用现有视觉—语言模型。提出基于开源 VLM OpenFlamingo 的视觉—语言操作框架 RoboFlamingo：用预训练 VLM 做单步视觉—语言理解，以显式策略头建模序列历史信息，并仅在语言条件操作数据集上用模仿学习轻度微调。该分解使其便于开环控制及在低性能平台部署。在所测基准上大幅超过当时先进水平，表明可将 VLM 有效适配到机器人控制；广泛实验还揭示不同预训练 VLM 在操作任务上的若干行为差异。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "VoxPoser 用语言模型合成可组合的三维价值图，表示操作约束与目标，再用运动规划在价值图上求解轨迹。系统无需任务演示，即可在真实与仿真中完成多样语言条件操作，并组合空间约束。它把语言推理接到三维几何，是代码 / 价值图 Agent 控制机械臂的代表。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "Voyager 是 Minecraft 中首个由 LLM 驱动的终身学习具身智能体：自动课程最大化探索，可增长的技能库存储可执行代码，迭代提示融入环境反馈、执行错误与自验证。它不微调模型参数，仅黑盒查询 GPT-4。相对先前方法，获得更多独特物品、旅行更远，科技树里程碑最快约 15.3 倍，并可将技能库迁移到新世界。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "既有 LLM 规划失败时往往只是重试同一动作。CAPE 针对前提错误提出纠正动作，用语言模型分析失败原因并生成能解除前提的修正，从而在规划执行中恢复，而不是盲目重试。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2211.09935",
    "pdf": "https://arxiv.org/pdf/2211.09935"
  },
  {
    "id": "2209.07753",
    "nickname": "Code as Policies",
    ...
    "abstractZh": "Code as Policies 把会写代码的 LLM 重用于生成机器人策略程序：策略代码可表达反馈回路、调用感知与控制原语，并引用 NumPy 等库做几何推理。通过少样本「指令注释 + 策略代码」提示与层次化代码生成（递归定义未定义函数），模型可写出反应式与航点式策略，并在多台真机上演示。层次化代码生成还将 HumanEval 求解率提升至 39.8%。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2209.07753"
  },
  {
    "id": "2206.14176",
    "nickname": "DayDreamer",
    ...
    "venue": "Website: https://danijar.com/daydreamer",
    ...
    "abstractZh": "深度强化学习需大量试错，限制了其在物理世界的部署；仿真学习又难以捕捉真实复杂性且行为难以适应变化。Dreamer 通过在所学 World Model 内规划，从少量交互学习。本文将 Dreamer 用于四台机器人，在真实世界在线直接学习、无需仿真器：四足机器人约一小时从零学会翻身、站立与行走且无需复位，受推后约十分钟适应；两台机械臂从相机图像与稀疏奖励学习多物体抓放并接近人类水平；轮式机器人仅从图像导航到目标并自动消解朝向歧义。各实验使用相同超参数，表明 Dreamer 可在真实世界在线学习。",
    "highlightsZh": [
  ...
  {
    "id": "2204.01691",
    "nickname": "Do As I Can, Not As I Say",
    ...
    "abstractZh": "大语言模型编码了丰富的世界语义知识，但缺乏真实世界经验，难以在给定本体中做决策。提出用预训练技能提供真实世界落地，约束模型提出既可行又符合情境的自然语言动作：机器人充当语言模型的“手与眼”，语言模型提供任务的高层语义知识。低层技能与大语言模型结合，由技能相关的价值函数将关于复杂、长时程指令程序的知识连接到具体物理环境。在多项真实机器人任务上评估，表明需要真实世界落地，且该方法能使移动操作机器人完成长时程、抽象的自然语言指令。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "Project website: https://innermonologue.github.io",
    ...
    "abstractZh": "具身规划不仅要决定做什么技能，还要考虑如何与何时执行，且答案随智能体自身选择而变化。本文研究在具身情境中使用的大语言模型能在多大程度上、无需额外训练地，对以自然语言提供的反馈进行推理。提出利用环境反馈形成内心独白，从而更丰富地处理并规划机器人控制场景。考察成功检测、场景描述与人类交互等多种反馈来源。发现闭环语言反馈在三个领域显著提高高层指令完成率，包括仿真与真实桌面重排任务，以及真实厨房环境中的长时程移动操作任务。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2207.05608"
  },
  {
    "id": "2201.07207",
    "nickname": "Language Models as Zero-Shot Planners",
    ...
    "abstractZh": "本文探讨能否把大语言模型学到的世界知识落地为可执行步骤，例如把「做早餐」映射为「打开冰箱」。作者评估若干提示方法，发现预训练 LLM 的计划常不可执行。他们提出可容许动作翻译，把自由生成计划映射到环境中可用动作，从而显著提高可执行性。该工作是后续 SayCan、Inner Monologue 与 Code as Policies 等机器人 Agent 的规划前驱。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2201.07207"
  },
  {
    "id": "2212.04088",
    "nickname": "LLM-Planner",
    "title": "LLM-Planner: Few-Shot Grounded Planning for Embodied Agents with Large Language Models",
    "authors": [
      "Chan Hee Song",
      "Jiaman Wu",
      "Clayton Washington et al."
    ],
    "year": 2022,
    "published": "2022-01-01",
    "tags": [
    ...
    "venue": "",
    "abstract": "This study focuses on using large language models (LLMs) as a planner for embodied agents that can follow natural language instructions to complete complex tasks in a visually-perceived environment. The high data cost and poor sample efficiency of existing methods hinders the development of versatile agents that are capable of many tasks and can learn new tasks quickly. In this work, we propose a novel method, LLM-Planner, that harnesses the power of large language models to do few-shot planning for embodied agents. We further propose a simple but effective way to enhance LLMs with physical grounding to generate and update plans that are grounded in the current environment. Experiments on the ALFRED dataset show that our method can achieve very competitive few-shot performance: Despite using less than 0.5% of paired training data, LLM-Planner achieves competitive performance with recent baselines that are trained using the full training data. Existing methods can barely complete any task successfully under the same few-shot setting. Our work opens the door for developing versatile and sample-efficient embodied agents that can quickly learn many tasks. Website: this https URL",
    "abstractZh": "LLM-Planner 把大语言模型用作具身智能体的少样本规划器：在视觉感知环境中跟随自然语言指令。为降低数据成本，它用 LLM 生成高层子目标，再与学得的低层策略结合，并可在执行中根据观察重新规划。在 ALFRED 等基准上，少样本设定下即可达到有竞争力的成功率。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2212.04088",
  ...
  },
  {
    ...
    "abstractZh": "视觉导航目标常用图像指定，接口不自然。LM-Nav 组合预训练语言模型、视觉—语言模型与视觉导航模型：LLM 把自由语言指令分解为地标列表，VLM 在拓扑图上接地这些地标，导航模型再执行。系统在真实户外环境中用语言指令导航，且无需语言标注的导航轨迹。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2207.04429",
    "pdf": "https://arxiv.org/pdf/2207.04429"
  },
  {
    "id": "2206.08853",
    "nickname": "MineDojo",
    ...
    "abstractZh": "开放世界智能体需要多样任务环境、大规模多模态知识与可扩展架构。MineDojo 在 Minecraft 上提供数千开放任务与互联网规模的视频、教程、维基与论坛知识库，并训练 MineCLIP 作为语言条件稠密奖励。该平台成为 Voyager、STEVE-1 与 GITM 等开放式具身 Agent 的共同底座。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "LLM 规划常缺场景接地。NLMap 提供开放词汇、可查询的场景表示，采集并整合环境上下文，使语言规划器能对真实场景提问并生成可执行计划。系统把开放词汇感知接到任务规划，服务真实世界机器人。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2209.09874",
    "pdf": "https://arxiv.org/pdf/2209.09874"
  },
  {
    "id": "2209.11302",
    "nickname": "ProgPrompt",
    ...
    "abstractZh": "任务规划通常需要大量领域知识。ProgPrompt 用程序化提示让 LLM 直接生成情境化机器人任务计划：提示包含环境状态、可用动作与示例，使生成计划可在真实与仿真机器人上执行。相对仅打分下一步的方法，直接生成动作序列更易利用 LLM 的程序结构，并在桌面操作任务上提高成功率。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2209.11302"
  },
  {
    "id": "2210.03629",
    "nickname": "ReAct",
    ...
    "abstractZh": "LLM 的推理（思维链）与行动（生成动作计划）此前多被分开研究。ReAct 交错生成推理轨迹与任务动作，使模型能规划、跟踪与更新行动，并处理异常。在问答与决策基准上，ReAct 优于仅推理或仅行动的基线，并减少幻觉。该范式被广泛接到机器人闭环（Inner Monologue、Voyager、VLN 工具调用）。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "经典任务规划假设封闭世界与完备知识，真实开放世界常出现未预见情形。本文提出开放世界任务规划与情境处理，使机器人在知识不全时仍能补全情境并继续执行，而不是让规划器完备性崩溃。",
    "highlightsZh": [
    ...
    "abstractSource": "arxiv_abs_html",
    "arxiv": "https://arxiv.org/abs/2210.01287",
    "pdf": "https://arxiv.org/pdf/2210.01287"
  },
  {
    "id": "2212.06817",
    "nickname": "RT-1",
    ...
    "venue": "See website at robotics-transformer1.github.io",
    ...
    "abstractZh": "通过从大型、多样、任务无关数据集迁移知识，现代机器学习模型可以零样本或仅用少量任务数据高水平完成下游任务；该能力已在视觉、语言与语音中得到展示，但在难以采集真实数据的机器人领域仍有待证明。本文认为通用机器人模型成功的关键在于开放式、任务无关训练，以及能吸收多样机器人数据的高容量架构。提出名为 Robotics Transformer 的模型类，展现有前景的可扩展模型性质，并基于真实机器人执行真实任务的大规模数据采集，研究不同模型类随数据规模、模型规模与数据多样性而泛化的能力。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "不同基础模型能力域仅部分重叠：VLM 擅长图像—语言，LLM 擅长互联网文本推理。Socratic Models 用语言作信息瓶颈，把多个预训练多模态模块组合成零样本多模态推理系统，而无需微调。该组合可做图像描述、问答与多模态辅助，并在机器人演示中把视觉检测接到 LLM 规划再调用语言条件策略。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "pdf": "https://arxiv.org/pdf/2202.09481"
  },
  {
    "id": "2209.00588",
    "nickname": "2209.00588",
    ...
    "abstractZh": "深度强化学习智能体样本效率低，限制了现实应用。许多基于模型的方法试图解决这一问题，在 World Model 的想象中学习是突出途径之一，但 World Model 必须在较长时间上保持准确。受 Transformer 在序列建模中成功的启发，提出数据高效智能体 IRIS，在由离散自编码器和自回归 Transformer 组成的 World Model 中学习。在 Atari 100k 基准上仅相当于约两小时游戏时间，平均人类归一化得分为 1.046，在二十六款游戏中的十款超过人类，为无前瞻搜索方法树立新的先进水平。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "venue": "ICML 2023 Camera-ready version. Project website: https://vimalabs.github.io/",
    ...
    "abstractZh": "基于提示的学习使通才语言模型可由输入提示执行指定任务，但机器人中的任务指定形式多样，常被视为不同任务并由专用模型处理。本文表明广泛的机器人操作任务可用交织文本与视觉 token 的多模态提示来表达，并构建包含数千个程序生成桌面任务、六十万余条专家轨迹与四级系统泛化评估协议的新仿真基准。设计基于 Transformer 的机器人智能体 VIMA，处理这些提示并自回归输出电机动作，兼具模型可扩展性与数据效率；在最难的零样本泛化设定下，同等数据时任务成功率最高可达其他设计的 2.9 倍，以 10 倍更少数据仍优于最佳竞争变体 2.7 倍。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2210.03094"
  },
  {
    "id": "2109.12098",
    "nickname": "CLIPort",
    ...
    "abstractZh": "精确操作与抽象概念推理难以兼得：端到端网络空间推理强但难泛化到新目标，而 CLIP 等语义模型缺空间精度。CLIPort 把语言条件的 CLIP 语义（what）与 Transporter 的空间操作（where）两条通路结合，用两个流式网络实现表格堆叠等语言条件操作。在未见物体、属性与未见语言上均能零样本泛化，并在多任务语言条件表格操作上设立强基线。",
    "highlightsZh": [
    ...
    "pdf": "https://arxiv.org/pdf/2109.12098"
  },
  {
    "id": "2010.02193",
    "nickname": "2010.02193",
  ...
  },
  {
    ...
    "abstractZh": "所学 World Model 总结智能体经验以促进学习复杂行为。尽管通过深度学习从高维感官输入学习 World Model 正变得可行，从中导出行为仍有多种潜在途径。提出 Dreamer：纯通过潜空间想象从图像解决长时程任务的强化学习智能体。在所学 World Model 的紧凑状态空间中想象轨迹，并将所学状态价值的解析梯度沿轨迹反向传播，从而高效学习行为。在二十项具有挑战性的视觉控制任务上，Dreamer 在数据效率、计算时间与最终性能上超过现有方法。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "规划在已知环境动力学的控制任务中非常成功；要在未知环境中利用规划，智能体需从与世界的交互中学习动力学。学习对规划足够准确的动力学模型长期具有挑战，尤其在基于图像的领域。提出纯基于模型的智能体 Deep Planning Network（PlaNet）：从图像学习环境动力学，并在潜空间中通过快速在线规划选择动作。为准确预测多步超前奖励，采用兼具确定性与随机转移分量的潜动力学模型，并提出名为 latent overshooting 的多步变分推断目标。仅用像素观测即可解决含接触动力学、部分可观测与稀疏奖励的连续控制任务，所用回合更少且最终性能接近有时高于强无模型算法。",
    "highlightsZh": [
  ...
  },
  {
    ...
    "abstractZh": "本文探索为流行的强化学习环境构建生成式神经网络模型。所提出的 World Model 能够以无监督方式快速训练，从而学习到环境在空间与时间维度上的压缩表示。通过将从该 World Model 中提取的特征作为智能体的输入，可以训练出非常紧凑且简单的策略来完成所需任务。甚至可以让智能体完全在由其自身 World Model 所生成的幻觉梦境内部接受训练，随后再把所得策略迁移回实际环境中执行。论文还提供了交互式版本。",
    "highlightsZh": [
...
export const paperCounts = {
  ...
  "families": {
    ...
    "Dreamer/robotics": 1,
    "GAIA": 1,
    "Genie reproduction": 2,
    "JEPA": 2,
    "LEO/embodied": 1,
    "Minecraft / Agent-robot": 1,
    "Minecraft / MineRL adjacent": 3,
    "NVIDIA Cosmos": 3,
    "Oasis/GameNGen-like": 1,
    "RT-X / OXE": 1,
    "Transformer WM": 4,
    "VLA": 5,
    "VLA / VLN": 1,
